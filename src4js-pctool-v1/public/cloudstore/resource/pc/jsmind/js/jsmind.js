...
;(function($w){
            ...
            _load_node:function(mind, parent_id, xml_node){
                ...
                if(node_topic == null){
                    ...
                    for(var i=0;i<topic_children.length;i++){
                        ...
                        //logger.info(topic_child.tagName);
                ...
                //logger.info(node_position +':'+ node_direction);
                if(!!parent_id){
    ...
    jm.prototype={
        ...
        _show:function(mind){
            ...
            this.view.load();
            logger.info('view.load ok');

            this.layout.layout();
            logger.info('layout.layout ok');

            this.view.show(true);
            logger.info('view.show ok');
    ...
    jm.layout_provider.prototype={
        ...
        _layout_offset_subnodes_height:function(nodes){
            ...
            while(i--){
                node = nodes[i];
                node._data.layout.offset_y += middle_height;
                //logger.info(node.topic);
                //logger.info(node._data.layout.offset_y);
            }
            return total_height;
        },

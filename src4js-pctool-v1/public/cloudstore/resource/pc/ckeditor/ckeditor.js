...
(function() {
    ...
    CKEDITOR.env || (CKEDITOR.env = function() {
        ...
        var c = 0;
        b.ie && (c = d ? parseFloat(d[1]) : b.quirks || !document.documentMode ? parseFloat(a.match(/msie (\d+)/)[1]) : document.documentMode,
        b.ie9Compat = 9 == c,
        b.ie8Compat = 8 == c,
        b.ie7Compat = 7 == c,
        b.ie6Compat = 7 > c || b.quirks);
        b.gecko && (d = a.match(/rv:([\d\.]+)/)) && (d = d[1].split("."),
    ...
    CKEDITOR.on("log", function(a) {
        if (window.console && window.console.log) {
            ...
            if (a = a.data.additionalData)
                ...
                console[d]("[CKEDITOR] Error code: " + b + ".");
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            clone: function(a) {
                ...
                if (null  === a || "object" != typeof a || a instanceof String || a instanceof Number || a instanceof Boolean || a instanceof Date || a instanceof RegExp || a.nodeType || a.window === a)
                    return a;
                f = new a.constructor;
                for (b in a)
                    f[b] = CKEDITOR.tools.clone(a[b]);
            ...
            extend: function(a) {
                ...
                "boolean" == typeof (b = arguments[f - 1]) ? f-- : "boolean" == typeof (b = arguments[f - 2]) && (c = arguments[f - 1],
                f -= 2);
                for (var k = 1; k < f; k++) {
                    var d = arguments[k], p;
                    for (p in d)
            ...
            buildStyleHtml: function(a) {
                ...
                b = [], c = 0; c < a.length; c++)
                    if (f = a[c])
                        /@import|[{}]/.test(f) ? b.push("\x3cstyle\x3e" + f + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + f + '"\x3e');
                return b.join("")
            },
            ...
            createClass: function(a) {
                ...
                if (c)
                    ...
                    ;
                b && (f.prototype = this.prototypedCopy(b.prototype),
            ...
            convertToPx: function() {
                ...
                return function(b) {
                    ...
                    return /%$/.test(b) ? b : (a.setStyle("width", b),
                    a.$.clientWidth)
                }
            }(),
            repeat: function(a, b) {
            ...
            parseCssText: function(a, b, c) {
                var k = {};
                c && (c = new CKEDITOR.dom.element("span"),
                ...
                a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function(a, c, d) {
                    b && (c = c.toLowerCase(),
                    "font-family" == c && (d = d.toLowerCase().replace(/["']/g, "").replace(/\s*,\s*/g, ",")),
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        return {
            ...
            on: function(d) {
                ...
                b[d] || (b = b[d] = a(this, d),
                this.$.addEventListener ? this.$.addEventListener(d, b, !!CKEDITOR.event.useCapture) : this.$.attachEvent && this.$.attachEvent("on" + 
                d, b));
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        clone: function(a, d) {
            function b(c) {
                ...
                if (c.nodeType == CKEDITOR.NODE_ELEMENT || c.nodeType == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                    if (d || c.nodeType != CKEDITOR.NODE_ELEMENT || c.removeAttribute("id", !1),
                    a) {
                        c = c.childNodes;
        ...
        getIndex: function(a) {
            ...
            var c = this.$, e = -1, g;
            if (!this.$.parentNode || a && c.nodeType == CKEDITOR.NODE_TEXT && b(c) && !d(c) && !d(c, !0))
                return -1;
            do
                a && c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (g || b(c)) || (e++,
                g = c.nodeType == CKEDITOR.NODE_TEXT);
            while (c = c.previousSibling);return e
        },
        getNextSourceNode: function(a, d, b) {
            ...
            if (!a) {
                if (this.type == 
                CKEDITOR.NODE_ELEMENT && b && !1 === b(this, !0))
                    return null ;
                a = this.getNext()
            }
        ...
        getPosition: function(a) {
            ...
            if (d.compareDocumentPosition)
                return d.compareDocumentPosition(b);
            if (d == b)
            ...
            CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if ("sourceIndex" in d)
                    return 0 > d.sourceIndex || 0 > b.sourceIndex ? CKEDITOR.POSITION_DISCONNECTED : d.sourceIndex < b.sourceIndex ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING
            }
            d = this.getAddress();
            a = a.getAddress();
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        createElement: function(a, d) {
            ...
            d && (d.attributes && b.setAttributes(d.attributes),
        ...
        _getHtml5ShivFrag: function() {
            ...
            a || (a = this.$.createDocumentFragment(),
    ...
    (function() {
        ...
        function d(a) {
            var b = !0;
            a.$.id || (a.$.id = "cke_tmp_" + CKEDITOR.tools.getNextNumber(),
            b = !1);
            return function() {
        ...
        function c(a) {
            for (var b = 0, c = 0, f = l[a].length; c < f; c++)
                b += parseInt(this.getComputedStyle(l[a][c]) || 0, 10) || 0;
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            appendBogus: function(a) {
                if (a || CKEDITOR.env.needsBrFiller) {
                    for (a = this.getLast(); a && a.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.rtrim(a.getText()); )
                        a = a.getPrevious();
                    a && a.is && a.is("br") || (a = this.getDocument().createElement("br"),
            ...
            isIdentical: function(a) {
                ...
                if (b.$.isEqualNode)
                    return b.$.style.cssText = CKEDITOR.tools.normalizeCssText(b.$.style.cssText),
                ...
                if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && this.is("a")) {
                    ...
                    c.type == CKEDITOR.NODE_ELEMENT && (c = c.clone(),
                    c.setHtml(b),
                    b = c.getHtml(),
                    c.setHtml(a),
                    a = c.getHtml())
            ...
            isVisible: function() {
                ...
                a && CKEDITOR.env.webkit && (b = this.getWindow(),
                !b.equals(CKEDITOR.document.getWindow()) && (c = b.$.frameElement) && (a = (new CKEDITOR.dom.element(c)).isVisible()));
                return !!a
            },
            isEmptyInlineRemoveable: function() {
                ...
                for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
                    ...
                    if (f.type != CKEDITOR.NODE_ELEMENT || !f.data("cke-bookmark"))
                        if (f.type == CKEDITOR.NODE_ELEMENT && !f.isEmptyInlineRemoveable() || f.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(f.getText()))
                            return !1
                }
                return !0
            },
            ...
            removeAttributes: function(a) {
                if (CKEDITOR.tools.isArray(a))
                    ...
                    for (b in a = a || this.getAttributes(),
                    a)
            ...
            setOpacity: function(a) {
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? (a = Math.round(100 * a),
                this.setStyle("filter", 100 <= a ? "" : "progid:DXImageTransform.Microsoft.Alpha(opacity\x3d" + a + ")")) : this.setStyle("opacity", a)
            },
            ...
            getPositionedAncestor: function() {
                for (var a = this; "html" != a.getName(); ) {
                    if ("static" != a.getComputedStyle("position"))
                        return a;
                    a = a.getParent()
                }
                return null 
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    ...
                    this.$.getBoundingClientRect()
                      ...
                      , l = !0;
                    CKEDITOR.env.ie && (l = f.getDocumentElement().contains(this),
                    f = f.getBody().contains(this),
                    l = e && f || !e && l);
                    l && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || g.scrollLeft,
                    c = d.$.scrollTop || g.scrollTop) : (c = e ? d.$ : g,
                    b = c.scrollLeft,
                    c = c.scrollTop),
                    b = t.left + b - x,
                    c = t.top + c - p)
                    ...
                    for (p = this,
                    x = null ; p && "body" != p.getName() && "html" != p.getName(); ) {
                        b += p.$.offsetLeft - 
                        p.$.scrollLeft;
                        c += p.$.offsetTop - p.$.scrollTop;
                        p.equals(this) || (b += p.$.clientLeft || 0,
                        c += p.$.clientTop || 0);
                        for (; x && !x.equals(p); )
                            b -= x.$.scrollLeft,
                            c -= x.$.scrollTop,
                ...
                a && (t = this.getWindow(),
                p = a.getWindow(),
                !t.equals(p) && t.$.frameElement && (a = (new CKEDITOR.dom.element(t.$.frameElement)).getDocumentPosition(a),
                b += a.x,
                c += a.y));
                document.documentElement.getBoundingClientRect || !CKEDITOR.env.gecko || e || (b += this.$.clientLeft ? 1 : 0,
                c += this.$.clientTop ? 
                1 : 0);
                return {
                    x: b,
            ...
            scrollIntoView: function(a) {
                ...
                if (b) {
                    do
                        if ((b.$.clientWidth && b.$.clientWidth < b.$.scrollWidth || b.$.clientHeight && b.$.clientHeight < b.$.scrollHeight) && !b.is("body") && this.scrollIntoParent(b, a, 1),
                        b.is("html")) {
                            var c = b.getWindow();
                            try {
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function p(a, b) {
                    ...
                    f = a.getWindow();
                    f.equals(b) || (f = p(CKEDITOR.dom.element.get(f.$.frameElement), b),
                    c.x += f.x,
                    c.y += f.y);
                    return c
                }
            ...
            copyAttributes: function(a, b) {
                ...
                for (var f = 0; f < c.length; f++) {
                    ...
                    if (!(e in b))
                        if ("checked" == e && (t = this.getAttribute(e)))
                            a.setAttribute(e, t);
                        else if (!CKEDITOR.env.ie || this.hasAttribute(e))
                            t = this.getAttribute(e),
                            null  === t && (t = d.nodeValue),
                            a.setAttribute(e, t)
                }
            ...
            getEditor: function() {
                ...
                for (b in a)
                    if (c = a[b],
                    c.element.equals(this) && c.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO)
                        return c;
                return null 
            },
            find: function(a) {
    ...
    (function() {
        function a(a, b) {
            ...
            (f = 0 < y ? f.getChild(y - 1) : !1 === r(f, !0) ? null  : f.getPreviousSourceNode(!0, n, r)) : (f = d,
            f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === r(d, !0) ? null  : d.getNextSourceNode(!0, n, r)))),
            f && !1 === r(f) && (f = null ));
            for (; f && !this._.end; ) {
                this.current = f;
        ...
        function d(b) {
            for (var c, f = null ; c = a.call(this, b); )
                f = c;
            return f
        }
        ...
        function(a) {
            ...
            return function(f) {
                b(f) ? f = 1 : (f.type == CKEDITOR.NODE_TEXT && (f = f.getParent()),
                f = f.$.offsetWidth <= c);
                return !!(a ^ f)
            }
        }
        ...
        CKEDITOR.dom.element.prototype.getBogus = function() {
            ...
            while (q(a));return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && e.test(a.getText())) ? a : !1
        }
    })();
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function p(a, b, c, f) {
                ...
                if (f && k)
                    return d;
                h || f ? b.append(a.clone(!0, e), c) : (a.remove(),
                r && b.append(a));
                return d
            }
            function g() {
            ...
            function l() {
                ...
                CKEDITOR.POSITION_BEFORE_START) : L == b + 1 && C ? a.moveToPosition(I[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(I[b + 1], CKEDITOR.POSITION_BEFORE_START),
                d && (b = v[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document),
                c.insertAfter(b),
                b.mergeSiblings(!1),
                a.moveToBookmark({
                    startNode: c
            ...
            if (h && m.type == CKEDITOR.NODE_TEXT && n.equals(m))
                n = a.document.createText(n.substring(z, B)),
                c.append(n);
            else {
                m.type == CKEDITOR.NODE_TEXT ? h ? Q = !0 : m = m.split(B) : 0 < m.getChildCount() ? B >= m.getChildCount() ? (m = m.getChild(B - 1),
                C = !0) : m = m.getChild(B) : w = C = !0;
                n.type == CKEDITOR.NODE_TEXT ? h ? q = !0 : n.split(z) : 0 < n.getChildCount() ? 0 === z ? (n = n.getChild(z),
                E = !0) : n = n.getChild(z - 1) : H = E = !0;
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            collapse: function(a) {
                a ? (this._setEndContainer(this.startContainer),
                this.endOffset = this.startOffset) : (this._setStartContainer(this.endContainer),
            ...
            createBookmark: function(a) {
                ...
                b.setHtml("\x26nbsp;");
                a && (d = "cke_bm_" + CKEDITOR.tools.getNextNumber(),
                ...
                e.collapse(!0);
                e.insertNode(b);
                c ? (this.setStartAfter(b),
                this.setEndBefore(c)) : this.moveToPosition(b, CKEDITOR.POSITION_AFTER_END);
                return {
            ...
            createBookmark2: function() {
                function a(b) {
                    ...
                    if (f.type == CKEDITOR.NODE_TEXT) {
                        ...
                        for (g = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT; )
                            g += e.getText().replace(CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE, "").length;
                        e = g;
                        f.getText() ? d += e : (g = f.getPrevious(c),
                        e ? (d = e,
                        f = g ? g.getNext() : f.getParent().getFirst()) : (f = f.getParent(),
                ...
                function b(a, c) {
                    ...
                    if (f) {
                        var d = a.container;
                        f.equals(d) && (a.offset -= CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE.length,
            ...
            trim: function(a, b) {
                ...
                c = this.endContainer;
                d = this.endOffset;
                b || e || !c || c.type != CKEDITOR.NODE_TEXT || (d ? (d >= c.getLength() || c.split(d),
                d = c.getIndex() + 1) : 
                d = c.getIndex(),
                c = c.getParent(),
                this.setEnd(c, d))
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    B.type == CKEDITOR.NODE_TEXT ? (C && (B = !CKEDITOR.tools.trim(B.substring(0, C)).length && B,
                    z = !!B),
                    B && ((n = B.getPrevious()) || (h = B.getParent()))) : (C && (n = B.getChild(C - 1) || B.getLast()),
                    n || (h = B));
                    for (h = c(h); h || n; ) {
                        if (h && !n) {
                            !m && h.equals(g) && (m = !0);
                            ...
                            !l.contains(h))
                                break;
                            z && "inline" == h.getComputedStyle("display") || (z = !1,
                            m ? k = h : this.setStartBefore(h));
                            n = h.getPrevious()
                        }
                        for (; n; )
                            if (B = !1,
                            n.type == CKEDITOR.NODE_COMMENT)
                                n = n.getPrevious();
                            else {
                    ...
                    h = n = null ;
                    m = z = !1;
                    B.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(B.substring(C)).length ? z = !0 : (z = !B.getLength(),
                    C == B.getLength() ? (n = B.getNext()) || (h = B.getParent()) : p(B, C) && (h = B.getParent())) : (n = B.getChild(C)) || (h = B);
                    for (; h || 
                    n; ) {
                        if (h && !n) {
                            !m && h.equals(g) && (m = !0);
                            if (e ? h.isBlockBoundary() : !l.contains(h))
                                break;
                            z && "inline" == h.getComputedStyle("display") || (z = !1,
                            m ? r = h : h && this.setEndAfter(h));
                            n = h.getNext()
                        }
                        for (; n; ) {
                            B = !1;
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        ;
                        if ((h = h.previous()) && h.type == CKEDITOR.NODE_ELEMENT && h.is("br"))
                            break
                    }
                    h = this.clone();
                    h.collapse();
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    d.guard = function(b, d) {
                        if (h(b))
                            return !0;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(n) || !1 === c && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))
                            return !1;
            ...
            setStart: function(b, c) {
                ...
                this.startOffset = 
                c;
                this.endContainer || (this._setEndContainer(b),
                this.endOffset = c);
                a(this)
            },
            setEnd: function(b, c) {
            ...
            splitBlock: function(a, b) {
                var c = new CKEDITOR.dom.elementPath(this.startContainer,this.root)
                  ...
                  , p = d.block
                  , g = null ;
                if (!c.blockLimit.equals(d.blockLimit))
                    return null ;
                "br" != a && (e || (e = this.fixBlock(!0, a),
                p = (new CKEDITOR.dom.elementPath(this.endContainer,this.root)).block),
                p || (p = this.fixBlock(!1, a)));
                c = e && this.checkStartOfBlock();
                d = p && this.checkEndOfBlock();
                this.deleteContents();
                e && e.equals(p) && 
                (d ? (g = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(p, CKEDITOR.POSITION_AFTER_END),
                p = null ) : c ? (g = new CKEDITOR.dom.elementPath(this.startContainer,this.root),
                this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START),
                e = null ) : (p = this.splitElement(e, b || !1),
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    ...
                    d.blockLimit, g; e && !e.equals(d.root) && !e.getFirst(a(e)); )
                        g = e.getParent(),
            ...
            checkStartOfBlock: function() {
                var a = this.startContainer
                  , c = this.startOffset;
                CKEDITOR.env.ie && c && a.type == CKEDITOR.NODE_TEXT && (a = CKEDITOR.tools.ltrim(a.substring(0, c)),
            ...
            checkEndOfBlock: function() {
                var a = this.endContainer
                  , c = this.endOffset;
                CKEDITOR.env.ie && a.type == CKEDITOR.NODE_TEXT && (a = CKEDITOR.tools.rtrim(a.substring(c)),
            ...
            checkReadOnly: function() {
                function a(b, c) {
                    for (; b; ) {
                        if (b.type == CKEDITOR.NODE_ELEMENT) {
                            if ("false" == b.getAttribute("contentEditable") && !b.data("cke-editable"))
                                return 0;
                            if (b.is("html") || 
                            "true" == b.getAttribute("contentEditable") && (b.contains(c) || b.equals(c)))
                                break
                        }
                        b = b.getParent()
                    }
            ...
            moveToElementEditablePosition: function(a, b) {
                if (a.type == CKEDITOR.NODE_ELEMENT && !a.isEditable(!1))
                    return this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START),
                    !0;
                for (var c = 0; a; ) {
                    if (a.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT)
                        ...
                        else if ("false" == a.getAttribute("contenteditable") && a.is(CKEDITOR.dtd.$block))
            ...
            moveToClosestEditablePosition: function(a, b) {
                ...
                c.moveToPosition(a, g[b ? 0 : 1])) : c = this.clone();
                if (a && !a.is(CKEDITOR.dtd.$block))
                    d = 1;
                else if (e = c[b ? "getNextEditableNode" : "getPreviousEditableNode"]())
                    d = 1,
                    (p = e.type == CKEDITOR.NODE_ELEMENT) && 
                    e.is(CKEDITOR.dtd.$block) && "false" == e.getAttribute("contenteditable") ? (c.setStartAt(e, CKEDITOR.POSITION_BEFORE_START),
                    c.setEndAt(e, CKEDITOR.POSITION_AFTER_END)) : !CKEDITOR.env.needsBrFiller && p && e.is(CKEDITOR.dom.walker.validEmptyBlockContainers) ? (c.setEnd(e, 0),
                    c.collapse()) : c.moveToPosition(e, g[b ? 1 : 0]);
            ...
            scrollIntoView: function() {
                ...
                a.insertAfter(e.startContainer)) : e.insertNode(a);
                a.scrollIntoView();
    ...
    (function() {
        function a(a) {
            1 > arguments.length || (this.range = a,
            this.forceBrBreak = 0,
            this.enlargeBr = 1,
        ...
        function b(a, c, e, g) {
            ...
            if (!g)
                return 0;
            if ((l = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !l.check(c))
                return b(a, 
                c, e, g.remaining);
            ...
            getNextParagraph: function(a) {
                ...
                if (this._.nestedEditable) {
                    if (d = this._.nestedEditable.iterator.getNextParagraph(a))
                        return this.activeFilter = this._.nestedEditable.iterator.activeFilter,
                        d;
                ...
                if (!this._.started) {
                    ...
                    p.collapsed || (l = new CKEDITOR.dom.walker(p.clone()),
                    x = CKEDITOR.dom.walker.bookmark(!0, !0),
                    l.evaluator = x,
                    this._.nextNode = l.next(),
                    l = new CKEDITOR.dom.walker(p.clone()),
                    l.evaluator = x,
                    l = l.previous(),
                    this._.lastNode = l.getNextSourceNode(!0, null , p.root),
                    this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (x = this.range.clone(),
                    x.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END),
                    x.checkEndOfBlock() && 
                    (x = new CKEDITOR.dom.elementPath(x.endContainer,x.root),
                    this._.lastNode = (x.block || x.blockLimit).getNextSourceNode(!0))),
                    this._.lastNode && p.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = p.document.createText(""),
                ...
                for (this._.nextNode = null ; x; ) {
                    var G = 0
                      ...
                      , h = 0;
                    if (r)
                        x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (r = 0);
                    else {
                        var n = x.getName();
                        if (CKEDITOR.dtd.$block[n] && "false" == x.getAttribute("contenteditable")) {
                            ...
                            l && (l.setEndAt(x, CKEDITOR.POSITION_BEFORE_START),
                            "br" != n && (this._.nextNode = x));
                            G = 1
                        } else {
                            if (x.getFirst()) {
                                l || (l = this.range.clone(),
                                l.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
                                x = x.getFirst();
                                continue
                            }
                            r = 1
                ...
                if (!d) {
                    if (!l)
                        return this._.docEndMarker && this._.docEndMarker.remove(),
                    ...
                    d = d.block;
                    !d && x && !this.enforceRealBlocks && G[x.getName()] && l.checkStartOfBlock() && l.checkEndOfBlock() && !x.equals(l.root) ? d = x : !d || this.enforceRealBlocks && d.is(q) ? (d = this.range.document.createElement(a),
                    l.extractContents().appendTo(d),
                    d.trim(),
                    l.insertNode(d),
                    t = D = !0) : "li" != d.getName() ? l.checkStartOfBlock() && l.checkEndOfBlock() || (d = d.clone(!1),
                    l.extractContents().appendTo(d),
                    d.trim(),
                    D = l.splitBlock(),
                    t = !D.wasStartOfBlock,
                    D = !D.wasEndOfBlock,
                    l.insertNode(d)) : A || (this._.nextNode = d.equals(p) ? null  : this._getNextSourceNode(l.getBoundaryNodes().endNode, 
                    1, p))
                }
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (p in v) {
                    ...
                    z = void 0;
                    for (z in r)
                        -1 < z.indexOf("*") ? g.push(new RegExp("^" + z.replace(/\*/g, ".*") + "$")) : g.push(z);
                    r = g;
                    r.length && (m[f] = r,
                    F = !1)
                }
                ...
                null  === h.elements)
                    ...
                    for (k in m = h.elements,
                    delete h.elements,
                    m)
                        if (b[k])
                            b[k][n ? "unshift" : "push"](h);
                        else
                            b[k] = [h]
            }
        }
        function d(a, c, d, h) {
            if (!a.match || a.match(c))
                if (h || k(a, c))
                    if (a.propertiesOnly || (d.valid = !0),
                    d.allAttributes || (d.allAttributes = b(a.attributes, c.attributes, d.validAttributes)),
                    ...
                    !d.allClasses) {
                        ...
                        if (a)
                            if (!0 === a)
                                ...
                                for (var n = 0, e = c.length, m; n < e; ++n)
                                    m = c[n],
                                    h[m] || 
                                    (h[m] = a(m));
                                a = !1
        ...
        function k(a, b) {
            ...
            if (h = a.requiredClasses)
                ...
                c = 0; c < h.length; ++c)
                    if (d = h[c],
                    "string" == typeof d) {
                        if (-1 == CKEDITOR.tools.indexOf(n, d))
                            return !1
                    } else if (!CKEDITOR.tools.checkIfAnyArrayItemMatches(n, d))
                        return !1;
        ...
        function f(a) {
            var b, c, d, h, n = {}, e = 1;
            for (a = R(a); b = a.match(I); )
                (c = b[2]) ? (d = y(c, "styles"),
                h = y(c, "attrs"),
                c = y(c, "classes")) : d = h = c = null ,
                n["$" + e++] = {
                    elements: b[1],
                    classes: c,
                    styles: d,
        ...
        function t(a, b, h, e) {
            ...
            if (e.doFilter) {
                ...
                if (!a.allAttributes)
                    for (C in g)
                        l[C] || (H.test(C) ? C == (I = C.replace(/^data-cke-saved-/, "")) || l[I] || (delete g[C],
                        v = !0) : (delete g[C],
                        v = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (C in k)
                        a.allStyles || B[C] ? K.push(C + ":" + k[C]) : v = !0;
        ...
        function h(a, b, c) {
            var d = a.name;
            if (C.$empty[d] || !a.children.length)
                ...
                if ("br" == b)
                    ...
                    b: {
                        ...
                        for (var n = 0, e = d.length, m; n < e; ++n)
                            if (m = d[n],
                            m.type == CKEDITOR.NODE_ELEMENT && !h[m.name]) {
                                h = !1;
                                break b
                            }
                        h = !0
                    ...
                    if (h)
                        ...
                        h = a.parent;
                        for (var n = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, f, g, e = d.length; 0 < e; )
                            m = d[--e],
                            n && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && C.$inline[m.name]) ? (f || (f = new CKEDITOR.htmlParser.element(b),
                            f.insertAfter(a),
                            c.push({
                                check: "parent-down",
                                el: f
                            ...
                            g = C[h.name] || C.span,
                            m.insertAfter(a),
                            h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || m.type != CKEDITOR.NODE_ELEMENT || g[m.name] || c.push({
                                check: "el-up",
                                el: m
                            }));
                        a.remove()
        ...
        function n(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (h = c[d],
                !(h.check && !a.check(h.check, !1) || h.left && !h.left(b))) {
                    h.right(b, K);
                    break
                }
        }
        function m(a, b) {
            ...
            for (n in d)
                if ("class" == n)
                    for (c = d[n].split(/\s+/),
                    m = a.classes.join("|"); f = c.pop(); ) {
                        if (-1 == m.indexOf(f))
                            return !1
                    }
                else if (a.attributes[n] != d[n])
                    return !1;
            for (e in h)
                if (a.styles[e] != 
                h[e])
        ...
        function z(a, b) {
            var c, d;
            "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0],
            d = a[1]);
            return [{
                element: c,
                left: d,
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                !0 === b ? this.disabled = !0 : (b || (this.customConfig = !1),
                this.allow(b, "config", 1),
                this.allow(a.config.extraAllowedContent, "extra", 1),
                this.allow(T[a.enterMode] + " " + T[a.shiftEnterMode], "default", 
                1),
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b)
                    ...
                    d && (d = 
                    H(d),
                    h.classes = d["class"] ? d["class"].split(/\s+/) : null ,
                    h.requiredClasses = h.classes,
                    delete d["class"],
                    h.attributes = d,
                    h.requiredAttributes = d && CKEDITOR.tools.objectKeys(d))
                } else if (CKEDITOR.tools.isArray(b)) {
                    for (h = 0; h < b.length; ++h)
                        n = this.allow(b[h], c, d);
                    return n
                }
            ...
            applyTo: function(a, b, c, d) {
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"])
                            return !1;
                ...
                for (var z; c = e.pop(); )
                    c.type == CKEDITOR.NODE_ELEMENT ? h(c, d, a) : c.remove();
                for (; r = a.pop(); )
                    if (c = r.el,
                    c.parent)
                        switch (z = C[c.parent.name] || C.span,
                        r.check) {
                        case "it":
                ...
                if (!this.disabled && a) {
                    ...
                    for (h = 0; h < a.length; ++h) {
                        ...
                        for (e = 0; e < b.length; ++e)
                            ...
                            r = m.right),
                            n || (n = m,
                            n = n.element ? n.element : f ? f.match(/^([a-z0-9]+)/i)[0] : 
                            n.left.getDefinition().element),
                            g instanceof CKEDITOR.style && (g = B(g)),
                            c.push({
                                check: f == n ? null  : f,
                                left: g,
            ...
            check: function(a, b, c) {
                ...
                if ("string" == typeof a) {
                    ...
                    h = d.styles,
                    m = d.attributes || {},
                    h && !CKEDITOR.tools.isEmpty(h) ? (h = H(h),
                    m.style = CKEDITOR.tools.writeCssText(h, !0)) : h = {},
                    h = {
                        name: d.element,
                        attributes: m,
        ...
        K = CKEDITOR.filter.transformationsTools = {
            ...
            transform: function(a, b) {
                if ("string" == typeof b)
                    ...
                    for (n in h)
                        if ("class" == n)
                            for (c = a.classes.join("|"),
                            e = h[n].split(/\s+/); f = e.pop(); )
                                -1 == c.indexOf(f) && a.classes.push(f);
                        else
                            a.attributes[n] = h[n];
                    for (m in d)
                        a.styles[m] = d[m]
    ...
    (function() {
        ...
        CKEDITOR.focusManager.prototype = {
            focus: function(a) {
                ...
                this.hasFocus || this._.locked || ((a = CKEDITOR.currentInstance) && a.focusManager.blur(1),
                this.hasFocus = !0,
            ...
            add: function(a, d) {
                ...
                if (!b || b != this) {
                    ...
                    "focus"
                      , c = "blur";
                    d && (CKEDITOR.env.ie ? (b = "focusin",
                    c = "focusout") : CKEDITOR.event.useCapture = 1);
                    var e = {
                        blur: function() {
        ...
        return {
            load: function(b, c, e, g) {
                ...
                if (0 === k)
                    ...
                    var y = function(a, b) {
                        (b ? q : w).push(a);
                        0 >= --k && (g && CKEDITOR.document.getDocumentElement().removeStyle("cursor"),
                        f(b))
                    }
                      , A = function(b, c) {
                        a[b] = 1;
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function(a, d, b) {
            ...
            CKEDITOR.scriptLoader.load(g, function(a, e) {
                if (e.length)
                    throw Error('[CKEDITOR.resourceManager.load] Resource name "' + l[e[0]].join(",") + '" was not found at "' + e[0] + '".');
              ...
              , l = function(b) {
                a.call(this, b, function(a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (k.icons)
                                for (var t = k.icons.split(","), D = t.length; D--; )
                                    CKEDITOR.skin.addIcon(t[D], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + t[D] + ".png");
                            d[f] = 1
                        }
                        if (A)
                            for (A.split && (A = A.split(",")),
                            k = 0; k < A.length; k++)
                                g[A[k]] || b.push(A[k])
                    }
                    if (b.length)
                        ...
                        for (f in g)
                            k = g[f],
                            k.onLoad && !k.onLoad._called && (!1 === k.onLoad() && delete g[f],
                            k.onLoad._called = 1);
                        c && c.call(e || window, g)
                    }
                }, this)
    ...
    (function() {
        ...
        function l(a) {
            ...
            CKEDITOR.getUrl(b)
              , c = D[b] || (D[b] = {});
            c.fn ? (c.fn.call(a, a.config),
            CKEDITOR.getUrl(a.config.customConfig) != b && l(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b, function() {
        ...
        function y(a) {
            ...
            b.removePlugins;
            if (d)
                var h = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)","g")
                  , c = c.replace(h, "")
                  , c = c + ("," + d);
            if (e)
                var n = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)","g")
                  , c = c.replace(n, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var f in c) {
                    ...
                    r && !a.lang[f] && (r.split && (r = r.split(",")),
                    0 <= CKEDITOR.tools.indexOf(r, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""),
                    l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(r, l) ? l : 0 <= CKEDITOR.tools.indexOf(r, "en") ? "en" : r[0]),
                    g.langEntries && g.langEntries[l] ? (a.lang[f] = g.langEntries[l],
                    l = null ) : e.push(CKEDITOR.getUrl(g.path + "lang/" + l + ".js")));
                    h.push(l);
                    d.push(g)
                }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                ...
                d.is("textarea") && e && (e.on("submit", a),
                b(e.$.submit) && (e.$.submit = CKEDITOR.tools.override(e.$.submit, function(b) {
                    return function() {
                        a();
            ...
            execCommand: function(a, b) {
                ...
                !1 !== this.fire("beforeCommandExec", d) && (d.returnValue = c.exec(d.commandData),
                !c.async && !1 !== this.fire("afterCommandExec", d)) ? d.returnValue : !1
            },
            ...
            setData: function(a, b, c) {
                var d = !0
                  , e = b;
                b && "object" == typeof b && (c = b.internal,
                e = b.callback,
                d = !b.noSnapshot);
            ...
            setReadOnly: function(a) {
                a = null  == a || a;
                this.readOnly != a && (this.readOnly = a,
            ...
            getSelectedHtml: function(a) {
                ...
                for (var d = new CKEDITOR.dom.documentFragment, e, h, n, m = 0; m < c.length; m++) {
                    var f = c[m]
                      , g = f.startContainer;
                    g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(),
                    ...
                    n = g.clone(),
                    e.append(n)),
                    n.append(f.cloneContents())) : d.append(f.cloneContents())
                }
            ...
            setKeystroke: function() {
                ...
                0)], c, d, e = b.length; e--; )
                    c = b[e],
                    d = 0,
                    CKEDITOR.tools.isArray(c) && (d = c[1],
                    c = c[0]),
                    d ? a[c] = d : delete a[c]
            },
            addFeature: function(a) {
            ...
            setActiveFilter: function(a) {
                a || (a = this.filter);
                this.activeFilter !== a && (this.activeFilter = a,
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, e, g = 0, l; c = this._.htmlPartsRegex.exec(b); ) {
                    ...
                    if (e = c[1])
                        if (e = e.toLowerCase(),
                        l && CKEDITOR.dtd.$cdata[e] && (this.onCDATA(l.join("")),
                        l = null ),
                        !l) {
                            this.onTagClose(e);
                            continue
    ...
    (function() {
        ...
        function(g, l, k) {
            function q(a) {
                ...
                if (0 < x.length)
                    for (var c = 0; c < x.length; c++) {
                        ...
                        f && !f[h] || a && e && !e[a] && CKEDITOR.dtd[a] ? h == u.name && (y(u, u.parent, 1),
                        c--) : (b || (w(),
                        b = 1),
                        d = d.clone(),
                        d.parent = u,
            ...
            D.onTagOpen = function(e, m, f, g) {
                ...
                if (a(m))
                    ...
                    if ("br" == e)
                        ...
                        for (; !(g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c,
                        m.isUnknown || u.isUnknown || g[e]); )
                            ...
                            !t(e, f))
                                D.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1);
                            else if (f in d && !t(e, f))
                                !m.returnPoint && (m.returnPoint = u),
                                u = u.parent;
                            else if (f in CKEDITOR.dtd.$inline && x.unshift(u),
                            u.parent)
                                y(u, u.parent, 1);
                            else {
                                m.isOrphan = 1;
            ...
            ;
            D.onText = function(a) {
                if (!(u._.hasInlineStarted && !G.length || h || r) && (a = CKEDITOR.tools.ltrim(a),
                0 === a.length))
                    return;
                var b = u.name
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a, 
            c, d) {
                for (var g = [this.findIndex(c), 0], l = 0, k = a.length; l < k; l++)
                    g.push({
                        value: a[l],
                        priority: c,
                        options: d
            ...
            execOnName: function(a, c) {
                for (var d = 0, g = this.rules, l = g.length, k; c && d < l; d++)
                    k = g[d],
    ...
    (function() {
            ...
            function n(a, d) {
                return function(h) {
                    if (h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var e = [], n = b(h), r, F;
                        if (n)
                            for (f(n, 1) && e.push(n); n; )
                                g(n) && (r = c(n)) && f(r) && ((F = c(r)) && !g(F) ? e.push(r) : (m(v).insertAfter(r),
                                r.remove())),
                                n = n.previous;
                        for (n = 0; n < e.length; n++)
                            e[n].remove();
                        if (e = !a || !1 !== ("function" == typeof d ? d(h) : d))
                            v || CKEDITOR.env.needsBrFiller || 
                            h.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? v || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || h.name in CKEDITOR.dtd.tr || h.name in CKEDITOR.dtd.$listItem) ? (e = b(h),
                            e = !e || "form" == h.name && "input" == e.name) : e = !1 : e = !1;
                        e && h.add(m(a))
                    }
                }
            }
            function f(a, b) {
                if ((!v || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && "br" == a.name && !a.attributes["data-cke-eol"])
                    return !0;
                var c;
                ...
                a.value = c[0]),
                !CKEDITOR.env.needsBrFiller && v && (!b || a.parent.name in z) || !v && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
            }
            var r = {
                elements: {}
            }, v = "html" == d, z = CKEDITOR.tools.extend({}, h), E;
            for (E in z)
                "#" in u[E] || delete z[E];
            for (E in z)
                r.elements[E] = n(v, a.config.fillEmptyBlocks);
            r.root = n(v, !1);
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml", function(a) {
                ...
                var e;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == h && (h = "div",
                c = "\x3cpre\x3e" + c + "\x3c/pre\x3e",
                e = 1);
                ...
                h && (e = c,
                !e.children.length && CKEDITOR.dtd[e.name][h] && (h = new CKEDITOR.htmlParser.element(h),
                e.add(h)));
                a.dataValue = c
            }, null , null , 5);
            b.on("toHtml", function(a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                ...
                b && "object" == typeof b ? (e = b.context,
                c = b.fixForBody,
                d = b.dontFilter,
                m = b.filter,
                n = b.enterMode,
                f = b.protectedWhitespaces) : e = b;
        ...
        u.$block)
          ...
          , z = {
            elements: {
                ...
                a: function(a) {
                    var b = a.attributes;
                    if (!(a.children.length || b.name || b.id || a.attributes["data-cke-saved-name"]))
                        return !1
                }
            }
        }
            ...
            elements: {
                ...
                table: function(a) {
                    a.children.slice(0).sort(function(a, b) {
                        var c, d;
                        a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(r, a.name),
                        d = CKEDITOR.tools.indexOf(r, b.name));
                        -1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1,
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (; ; ) {
                    ...
                    if (d.type != CKEDITOR.NODE_ELEMENT)
                        ...
                        !1;
                    if (!d.name)
                        return this.replaceWithChildren(),
                        !1
                }
                l = d.attributes;
                var q, w;
            ...
            split: function(a) {
                for (var b = this.children.splice(a, this.children.length - a), d = this.clone(), l = 0; l < b.length; ++l)
                    b[l].parent = d;
                d.children = b;
    ...
    CKEDITOR.add = function(a) {
        ...
        a.on("focus", function() {
            CKEDITOR.currentInstance != a && (CKEDITOR.currentInstance = a,
            CKEDITOR.fire("currentInstance"))
        });
        a.on("blur", function() {
            CKEDITOR.currentInstance == a && (CKEDITOR.currentInstance = null ,
            CKEDITOR.fire("currentInstance"))
        });
    ...
    (function() {
        CKEDITOR.inline = function(a, d) {
            ...
            c ? (b.setData(c.getValue(), null , !0),
            a = CKEDITOR.dom.element.createFromHtml('\x3cdiv contenteditable\x3d"' + !!b.readOnly + '" class\x3d"cke_textarea_inline"\x3e' + c.getValue() + "\x3c/div\x3e", CKEDITOR.document),
            a.insertAfter(c),
            c.hide(),
            c.$.form && b._attachToForm()) : b.setData(a.getHtml(), null , !0);
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, g = c.count(); e < g; e++)
                    a = c.getItem(e),
    ...
    (function() {
        function a(a, e, g, l) {
            ...
            l == CKEDITOR.ELEMENT_MODE_REPLACE && (a.setStyle("visibility", "hidden"),
            ...
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (l.name || l.id) {
                    if ("string" == typeof arguments[0]) {
                        if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(l.className))
                            continue
                    } else if ("function" == typeof arguments[0] && (d = {},
                    !1 === arguments[0](l, d)))
                        continue;this.replace(l, d)
                }
            }
        }
        ;
    ...
    (function() {
        function a(a) {
            ...
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
                if (f = d(f, e))
                    f.appendBogus(),
                    E = CKEDITOR.env.ie;
            l(b, e.block, m) && g.collapsed && !g.getCommonAncestor().isReadOnly() && (e = g.clone(),
            e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS),
            m = new CKEDITOR.dom.walker(e),
            m.guard = function(a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            }
            ,
            !m.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && 
            (b = g.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"),
            CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(),
            E = 1,
            a.cancel());
            E && g.select()
        }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                focus: function() {
                    ...
                    CKEDITOR.env.safari && !this.isInline() && (a = CKEDITOR.document.getActive(),
                    a.equals(this.getWindow().getFrame()) || this.getWindow().focus())
                },
                on: function(a, b) {
                    var c = Array.prototype.slice.call(arguments, 0);
                    CKEDITOR.env.ie && /^focus|blur$/.exec(a) && (a = "focus" == a ? "focusin" : "focusout",
                    b = e(b, this),
                    c[0] = a,
                    c[1] = b);
                ...
                changeAttr: function(a, b) {
                    ...
                    b !== c && (!this._.attrChanges && (this._.attrChanges = {}),
                ...
                insertElement: function(a, b) {
                    ...
                    b || (b = d.getRanges()[0]);
                    this.insertElementIntoRange(a, b) && (b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END),
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (f)
                        ...
                        (!l || !l[e]); )
                            g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g),
                            b.collapse(!0),
                            g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                },
                ...
                fixInitialSelection: function() {
                    function a() {
                        ...
                        a: if (d.anchorNode && d.anchorNode == c.$)
                            h = !0;
                        else {
                        ...
                        h && (h = new CKEDITOR.dom.range(c),
                        h.moveToElementEditStart(c),
                        b = b.createRange(),
                        b.setStart(h.startContainer.$, h.startOffset),
                        b.collapse(!0),
                        d.removeAllRanges(),
                        d.addRange(b))
                    }
                    function b() {
                        ...
                        "None" == d.type && h.equals(c) && (d = new CKEDITOR.dom.range(c),
                ...
                extractHtmlFromRange: function(a, b) {
                    ...
                    d.range = a) : (a.moveToBookmark(d.bookmark),
                    d.range = a,
                ...
                setup: function() {
                    ...
                    this.equals(CKEDITOR.document.getActive()) && (this.hasFocus = !0,
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (m) {
                            ...
                            l ? m != l.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? l.$.styleSheet.cssText = m : l.setText(m)) : (m = d.appendStyleText(m),
                            m = new CKEDITOR.dom.element(m.ownerNode || m.owningElement),
                            e.setCustomData("stylesheet", m),
                            m.data("cke-temp", 1))
                        }
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in k) {
                                ...
                                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && (h = b.getSelectedElement()) || (h = g(b)) ? (a.fire("saveSnapshot"),
                                e.moveToPosition(h, CKEDITOR.POSITION_BEFORE_START),
                                h.remove(),
                                e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : e.collapsed && ((n = m.block) && (z = n[c ? "getPrevious" : "getNext"](f)) && z.type == CKEDITOR.NODE_ELEMENT && z.is("table") && e[c ? "checkStartOfBlock" : "checkEndOfBlock"]() ? (a.fire("saveSnapshot"),
                                e[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && n.remove(),
                                e["moveToElementEdit" + (c ? "End" : "Start")](z),
                                e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : m.blockLimit && m.blockLimit.is("td") && (l = m.blockLimit.getAscendant("table")) && e.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) && 
                                (z = l[c ? "getPrevious" : "getNext"](f)) ? (a.fire("saveSnapshot"),
                                e["moveToElementEdit" + (c ? "End" : "Start")](z),
                                e.checkStartOfBlock() && e.checkEndOfBlock() ? z.remove() : e.select(),
                                a.fire("saveSnapshot"),
                                d = 1) : (l = m.contains(["td", "th", "caption"])) && e.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) && (d = 1))
                            }
                            return !d
                        });
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function(b) {
                            b.data.getKeystroke() in k && !this.getFirst(c) && (this.appendBogus(),
                            b = a.createRange(),
                        ...
                        CKEDITOR.env.ie && !CKEDITOR.env.edge || this.attachListener(this, "mousedown", function(b) {
                            ...
                            c.is("img", "hr", "input", "textarea", "select") && !c.isReadOnly() && (a.getSelection().selectElement(c),
                        ...
                        CKEDITOR.env.gecko && this.attachListener(this, "mouseup", function(b) {
                            if (2 == b.data.$.button && (b = b.data.getTarget(),
                            !b.getOuterHtml().replace(D, ""))) {
                                var c = a.createRange();
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function(b) {
                            ...
                            if (b in k) {
                                ...
                                if (d.collapsed)
                                    ...
                                    f = b.block,
                                    d = c.endPath().block,
                                    f && d && !f.equals(d) ? (a.fire("saveSnapshot"),
                                    (h = f.getBogus()) && h.remove(),
                                    c.enlarge(CKEDITOR.ENLARGE_INLINE),
                                    c.deleteContents(),
                                    d.getParent() && (d.moveChildren(f, !1),
                                    b.lastElement.mergeSiblings(),
                                    w(f, d, !0)),
        ...
        CKEDITOR.on("instanceLoaded", function(b) {
            ...
            c.on("insertElement", function(a) {
                a = a.data;
                a.type == CKEDITOR.NODE_ELEMENT && (a.is("input") || a.is("textarea")) && ("false" != a.getAttribute("contentEditable") && a.data("cke-editable", a.hasAttribute("contenteditable") ? "true" : "1"),
                a.setAttribute("contentEditable", !1))
            });
            c.on("selectionChange", function(b) {
                if (!c.readOnly) {
                    var d = c.getSelection();
                    d && !d.isLocked && (d = c.checkDirty(),
                    c.fire("lockSnapshot"),
                    a(b),
        ...
        p = function() {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var l = C[l.getName()], z = 0, k = c.getChildren(), E = k.count(), B = -1, p = -1, q = 0, w = e.contains(C.$list); z < E; ++z)
                    e = k.getItem(z),
                    a(e) ? (m = e.getName(),
                    w && m in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (n = !!l[m],
                    "br" != m || !e.data("cke-eol") || z && z != E - 1 || (q = (f = z ? g[z - 1].node : k.getItem(z + 1)) && (!a(f) || !f.is("br")),
                    f = f && a(f) && C.$block[f.getName()]),
                    -1 != B || n || (B = z),
                    n || (p = z),
                    g.push({
                        isElement: 1,
            ...
            function d(b, c) {
                ...
                for (z && e.push(" "); g < f; g++)
                    m = h.getItem(g),
                    a(m) && !m.is(l) ? e = e.concat(d(m, c)) : e.push(m);
                z && e.push(" ");
                return e
            }
            function e(b) {
            ...
            function g(b, c, d, e) {
                ...
                (f = (new CKEDITOR.dom.walker(h)).next()) && a(f) && p[f.getName()] && (m = f.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && d.contains(m) && e.contains(f) && f.isIdentical(m) && (f.moveChildren(m),
                f.remove(),
                g(b, c, d, e))
            }
            function E(b, c) {
                ...
                1);
                e && d(e, b[b.length - 1]);
                h && d(h, b[0]) && (c.setEnd(c.endContainer, c.endOffset - 1),
                c.collapse())
            }
            var C = CKEDITOR.dtd
              , p = {
            ...
            return function(p, v, I, J) {
                ...
                if (!J.checkReadOnly()) {
                    ...
                    J = p.mergeCandidates;
                    var H, t;
                    "text" == p.type && v.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (H = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", v.document),
                    v.insertNode(H),
                    v.setStartAfter(H));
                    ...
                    for (; (t = e(v)) && a(t) && t.isBlockBoundary() && L.contains(t); )
                        v.moveToPosition(t, CKEDITOR.POSITION_BEFORE_END);
                    g(v, p.blockLimit, L, K);
                    H && (v.setEndBefore(H),
                    v.collapse(),
                    H.remove());
                    H = v.startPath();
                    if (F = H.contains(f, !1, 1))
                        v.splitElement(F),
                        p.inlineStylesRoot = F,
                        p.inlineStylesPeak = H.lastElement;
                    H = v.createBookmark();
                    (F = H.startNode.getPrevious(c)) && a(F) && f(F) && J.push(F);
                    (F = H.startNode.getNext(c)) && a(F) && f(F) && J.push(F);
                    for (F = H.startNode; (F = F.getParent()) && f(F); )
                        J.push(F);
                    v.moveToBookmark(H);
                    if (H = I) {
                        H = p.range;
                        if ("text" == p.type && p.inlineStylesRoot) {
                            ...
                            for (J = p.inlineStylesRoot.getParent(); !t.equals(J); )
                                v = v.appendTo(t.clone()),
                                t = t.getParent();
                        ...
                        A && (t.getFirst().remove(),
                        t.getLast().remove());
                        if ((A = H.startPath().block) && (1 != A.getChildCount() || !A.getBogus()))
                            a: {
                                var y;
                    ...
                    if (H) {
                        ...
                        for (E(v, y); J < v.length; J++) {
                            ...
                            if (u = K.isLineBreak) {
                                ...
                                aa == CKEDITOR.POSITION_CONTAINS ? u = 0 : (P = u.splitElement(S),
                                u.moveToPosition(P, CKEDITOR.POSITION_AFTER_START),
                                u = 1)) : u = 0
                            }
                            if (u)
                                I = 0 < J;
                                ...
                                u = y.startPath();
                                !K.isBlock && l(p.editor, u.block, u.blockLimit) && (G = k(p.editor)) && (G = H.createElement(G),
                                G.appendBogus(),
                                y.insertNode(G),
                                CKEDITOR.env.needsBrFiller && (D = G.getBogus()) && D.remove(),
                                y.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (F && K.isElement) {
                                    ...
                                    if (u)
                                        ...
                                        u = J == v.length - 1;
                                        P = d(K.node, P);
                                        for (var S = [], aa = P.length, ca = 0, ea = void 0, Y = 0, U = -1; ca < aa; ca++)
                                            ea = P[ca],
                                            " " == ea ? (Y || X && !ca || (S.push(new CKEDITOR.dom.text(" ")),
                                            U = S.length),
                                            Y = 1) : (S.push(ea),
                                            Y = 0);
                                        u && U == S.length && S.pop();
                                ...
                                if (X) {
                                    ...
                                    y.insertNode(K.node);
                                K.lastNotAllowed && J < 
                                v.length - 1 && ((W = x ? L : W) && y.setEndAt(W, CKEDITOR.POSITION_AFTER_START),
                                F = 0);
                                y.collapse()
                            }
                        }
                        1 != v.length ? D = !1 : (D = v[0],
                        D = D.isElement && "false" == D.node.getAttribute("contenteditable"));
                        D && (I = !0,
                        u = v[0].node,
                        y.setStartAt(u, CKEDITOR.POSITION_BEFORE_START),
                    ...
                    for (X = D.createBookmark(); M = p.zombies.pop(); )
                        M.getParent() && (G = D.clone(),
                        G.moveToElementEditStart(M),
                        G.removeEmptyBlocksAtEnd());
                    if (W)
                        for (; M = 
                        W.pop(); )
                            CKEDITOR.env.needsBrFiller ? M.appendBogus() : M.append(D.document.createText(" "));
                    for (; M = p.mergeCandidates.pop(); )
                        M.mergeSiblings();
                    D.moveToBookmark(X);
                    if (!p.dontMoveCaret) {
                        for (M = e(D); M && a(M) && !M.is(C.$empty); ) {
                            if (M.isBlockBoundary())
                                D.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END);
                            else {
        ...
        x = function() {
            ...
            function c(a) {
                ...
                for (b; 0 < b--; )
                    d = a.getItem(b),
                    CKEDITOR.tools.trim(d.getHtml()) || (d.appendBogus(),
        ...
        G = {
            eol: {
                detect: function(a, b) {
                    ...
                    d.collapse(1);
                    e.collapse();
                    f.block && d.checkBoundaryOfElement(f.block, CKEDITOR.END) && (c.setStartAfter(f.block),
                    a.prependEolBr = 1);
                    g.block && e.checkBoundaryOfElement(g.block, CKEDITOR.START) && (c.setEndBefore(g.block),
                    a.appendEolBr = 1)
                },
                fix: function(a, b) {
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list),
        ...
        u = function() {
            ...
            return {
                    ...
                    function a(c) {
                        ...
                        h.guard = function(a, h) {
                            ...
                            if (h && g && a.equals(g))
                                ...
                                e.push(f);
                            else if (!h && m && a.equals(m))
                                f = c.clone(),
                                f.setStartAt(m, CKEDITOR.POSITION_AFTER_START),
                                e.push(f);
                            else {
                                if (l = !h)
                                    l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!g || b(a, g)) && (!m || b(a, m));
                                l && (f = c.clone(),
                    ...
                    return {
                        detectPurge: function(a) {
                            ...
                            if (1 < e) {
                                ...
                                c && f && b.checkBoundaryOfElement(c, CKEDITOR.START) && b.checkBoundaryOfElement(f, CKEDITOR.END) && (b = a.range.clone(),
                                b.setStartBefore(c),
                                b.setEndAfter(f),
                        ...
                        detectRanges: function(e, f) {
                            ...
                            k = k.contains("table");
                            if (v || k)
                                v && k && b(v, k) ? (e.tableSurroundingRange = g,
                                g.setStartAt(v, CKEDITOR.POSITION_AFTER_END),
                                g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START),
                                g = h.clone(),
                                g.setEndAt(v, CKEDITOR.POSITION_AFTER_END),
                                l = h.clone(),
                                l.setStartAt(k, CKEDITOR.POSITION_BEFORE_START),
                                l = a(g).concat(a(l))) : v ? k || (e.tableSurroundingRange = g,
                                g.setStartAt(v, CKEDITOR.POSITION_AFTER_END),
                                h.setEndAt(v, 
                                CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = g,
                                g.setEndAt(k, CKEDITOR.POSITION_BEFORE_START),
                                h.setStartAt(k, CKEDITOR.POSITION_AFTER_START)),
                                e.tableContentsRanges = l ? l : a(h)
                        },
                ...
                autoParagraph: function(a, b) {
                    var c = b.startPath(), d;
                    l(a, c.block, c.blockLimit) && (d = k(a)) && (d = b.document.createElement(d),
                    d.appendBogus(),
                    b.insertNode(d),
    ...
    (function() {
        function a() {
            ...
            b = this.elementPath();
            b.compare(this._.selectionPreviousPath) || (CKEDITOR.env.webkit && (this._.previousActive = this.document.getActive()),
        ...
        function b() {
            y = null ;
            A && (CKEDITOR.tools.setTimeout(a, 0, this),
            A = !1)
        }
        function c(a) {
                ...
                if (!c.collapsed) {
                    if (c.startContainer.isReadOnly())
                        for (var d = c.startContainer, e; d && !((e = d.type == CKEDITOR.NODE_ELEMENT) && d.is("body") || !d.isReadOnly()); )
                            e && "false" == 
                            d.getAttribute("contentEditable") && c.setStartAfter(d),
                            d = d.getParent();
                    d = c.startContainer;
                    e = c.endContainer;
                    var f = c.startOffset
                    ...
                    d.evaluator = function(d) {
                        if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
                            ...
                            CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d),
        ...
        var y, A, t = CKEDITOR.dom.walker.invisible(1), D = function() {
            ...
            function b(a) {
                return function(b) {
                    ...
                    c.fire("saveSnapshot");
                    b.selected.remove();
                    e || (d.moveToElementEditablePosition(c.editable()),
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            e.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && g.attachListener(g, "focus", function(a) {
                    a.removeListener();
                    0 !== v && (a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == g.$ && (a = e.createRange(),
                ...
                if (CKEDITOR.env.ie || q)
                    p ? g.attachListener(g, "beforedeactivate", b, null , null , -1) : g.attachListener(e, "selectionCheck", b, null , null , -1),
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    g.attachListener(g, "mouseup", function(a) {
                        2 == a.data.$.button && J && (e.document.$.documentElement.scrollLeft = J.x,
                        e.document.$.documentElement.scrollTop = J.y);
                        J = null 
                    });
                    if ("BackCompat" != f.$.compatMode) {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version)
                            k.on("mousedown", function(a) {
                                a.data.getTarget().is("html") && (h.on("mouseup", c),
                                k.on("mouseup", c))
                            })
                    }
                }
            ...
            e.on("loadSnapshot", function() {
                ...
                CKEDITOR.env.gecko && (a = e.editable().getFirst(a)) && a.is("br") && a.getAttribute("_moz_editor_bogus_node") && a.remove())
            }, null , null , 100);
            e.on("key", function(a) {
                if ("wysiwyg" == e.mode) {
        ...
        CKEDITOR.dom.selection.prototype = {
                ...
                var a = p ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), l = 0, v = e.length - 1, k = -1, m, p; l <= v; )
                            if (k = Math.floor((l + v) / 2),
                            f = e[k],
                            g.moveToElementText(f),
                            m = g.compareEndPoints("StartToStart", b),
                            0 < m)
                                v = k - 1;
                            else if (0 > m)
                                l = k + 1;
                        ...
                        if (-1 == k || k == e.length - 1 && 0 > m) {
                            ...
                            for (d = e.length; 0 < g && 0 < d; )
                                h = e[--d],
                                h.nodeType == CKEDITOR.NODE_TEXT && (p = h,
                        ...
                        for (; 0 < g; )
                            try {
                                ...
                                h.nodeType == CKEDITOR.NODE_TEXT && (g -= h.nodeValue.length,
                                p = h),
                                f = h
                            } catch (q) {
                                return {
                    ...
                    return function() {
                        ...
                        if (d == CKEDITOR.SELECTION_TEXT)
                            return a = new CKEDITOR.dom.range(this.root),
                            d = b(c, !0),
                ...
                case CKEDITOR.SELECTION_TEXT:
                    ...
                    if (c) {
                        if (c.collapsed)
                            ...
                            for (c.optimize(); b = 
                            c.startContainer,
                            c.startOffset == (b.getChildCount ? b.getChildCount() : b.getLength()) && !b.isBlockBoundary(); )
                                c.setStartAfter(b);
                            b = c.startContainer;
                            if (b.type != CKEDITOR.NODE_ELEMENT)
                                return b.getParent();
            ...
            getSelectedElement: function() {
                var a = this._.cache;
                if (void 0 !== a.selectedElement)
                    return a.selectedElement;
                var b = this
                  , c = CKEDITOR.tools.tryThese(function() {
                    return b.getNative().createRange().item(0)
                }, function() {
                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && G[c.getName()] && (d = c)); e--)
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var q, w;
                            if (1 == a.length && !(w = a[0]).collapsed && (k = w.getEnclosedNode()) && k.type == CKEDITOR.NODE_ELEMENT && (w = w.clone(),
                            w.shrink(CKEDITOR.SHRINK_ELEMENT, 
                            !0),
                            (q = w.getEnclosedNode()) && q.type == CKEDITOR.NODE_ELEMENT && (k = q),
                            "false" == k.getAttribute("contenteditable")))
                                break a;
                            k = void 0
                        }
                        if (k)
                            ...
                            if (p) {
                                ...
                                1 < a.length && (k = a[a.length - 1],
                                a[0].setEnd(k.endContainer, k.endOffset));
                                k = a[0];
                                a = k.collapsed;
                                var t, u, r;
                                if ((c = k.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in G && (!c.is("a") || !c.getText()))
                                    try {
                                ...
                                if (k.startContainer.type == CKEDITOR.NODE_ELEMENT && k.startContainer.getName() in b || k.endContainer.type == CKEDITOR.NODE_ELEMENT && k.endContainer.getName() in b)
                                    k.shrink(CKEDITOR.NODE_ELEMENT, !0),
                                    a = k.collapsed;
                                r = k.createBookmark();
                                b = r.startNode;
                                a || (f = r.endNode);
                                ...
                                f ? (q = k.document.$.body.createTextRange(),
                                q.moveToElementText(f.$),
                                r.setEndPoint("EndToEnd", q),
                                r.moveEnd("character", -1)) : (t = b.getNext(w),
                                u = 
                                b.hasAscendant("pre"),
                                t = !(t && t.getText && t.getText().match(q)) && (u || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br")),
                                u = k.document.createElement("span"),
                                u.setHtml("\x26#65279;"),
                                u.insertBefore(b),
                                t && k.document.createText("﻿").insertBefore(b));
                                k.setStartBefore(b);
                                b.remove();
                                a ? (t ? (r.moveStart("character", -1),
                                r.select(),
                                k.document.$.selection.clear()) : r.select(),
                                k.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START),
                                u.remove()) : (k.setEndBefore(f),
                                f.remove(),
                                r.select())
                            } else {
                                f = this.getNative();
                                ...
                                for (r = 0; r < a.length; r++) {
                                    if (r < a.length - 1 && (t = a[r],
                                    u = a[r + 1],
                                    q = t.clone(),
                                    q.setStart(t.endContainer, t.endOffset),
                                    q.setEnd(u.startContainer, u.startOffset),
                                    !q.collapsed && (q.shrink(CKEDITOR.NODE_ELEMENT, !0),
                                    k = q.getCommonAncestor(),
                                    q = q.getEnclosedNode(),
                                    k.isReadOnly() || q && q.isReadOnly()))) {
                                    ...
                                    k.collapsed && CKEDITOR.env.webkit && e(k) && (q = g(this.root),
                                    k.insertNode(q),
                                    (t = 
                                    q.getNext()) && !q.getPrevious() && t.type == CKEDITOR.NODE_ELEMENT && "br" == t.getName() ? (l(this.root),
                                    k.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START)) : k.moveToPosition(q, CKEDITOR.POSITION_AFTER_END));
                                    u.setStart(k.startContainer.$, k.startOffset);
                                    try {
                                        u.setEnd(k.endContainer.$, k.endOffset)
                                    } catch (I) {
                                        if (0 <= I.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
                                            k.collapse(1),
                                            u.setEnd(k.endContainer.$, k.endOffset);
                                        else
                                            throw I;
            ...
            selectBookmarks: function(a) {
                ...
                a.isFake && (c = b[0].getEnclosedNode(),
                c && c.type == CKEDITOR.NODE_ELEMENT || (CKEDITOR.warn("selection-not-fake"),
                a.isFake = 0));
    ...
    (function() {
                ...
                for (t.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t; ) {
                    ...
                    if (t.equals(w))
                        ...
                        if (z)
                            ...
                            C = g,
                            E = l,
                            !B || !(B.getDtd() || CKEDITOR.dtd.span)[C] && !E || z.parentRule && !z.parentRule(B))
                                k = !0;
                            else {
                                if (r || 
                                y && CKEDITOR.dtd.$removeEmpty[y] && (t.getPosition(w) | T) != T || (r = c.clone(),
                                r.setStartBefore(t)),
                                y = t.type,
                                y == CKEDITOR.NODE_TEXT || u || y == CKEDITOR.NODE_ELEMENT && !t.getChildCount()) {
                                    for (var y = t, Y; (k = !y.getNext(H)) && (Y = y.getParent(),
                                    n[Y.getName()]) && d(Y, q, h, Q); )
                                        y = Y;
                                    r.setEndAfter(y)
                                }
                            }
                    ...
                    if (k && r && !r.collapsed) {
                        for (var k = G(this, f), u = k.hasAttributes(), x = r.getCommonAncestor(), y = {}, z = {}, B = {}, C = {}, U, O, da; k && x; ) {
                            if (x.getName() == g) {
                                for (U in h.attributes)
                                    !C[U] && (da = x.getAttribute(O)) && 
                                    (k.getAttribute(U) == da ? z[U] = 1 : C[U] = 1);
                                for (O in h.styles)
                                    !B[O] && (da = x.getStyle(O)) && (k.getStyle(O) == da ? y[O] = 1 : B[O] = 1)
                            }
                            x = x.getParent()
                        }
                        for (U in z)
                        ...
                        k ? (r.extractContents().appendTo(k),
                        r.insertNode(k),
                        D.call(this, k),
                        k.mergeSiblings(),
                        CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"),
                        r.extractContents().appendTo(k),
                        r.insertNode(k),
                        D.call(this, k),
                        k.remove(!0));
                        r = null 
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(),a.root), f, g = 0, k; g < e.elements.length && (k = e.elements[g]) && k != e.block && k != e.blockLimit; g++)
                    if (this.checkElementRemovable(k)) {
                        var l;
                        a.collapsed && (a.checkBoundaryOfElement(k, CKEDITOR.END) || (l = a.checkBoundaryOfElement(k, CKEDITOR.START))) ? (f = k,
                        f.match = l ? "start" : "end") : (k.mergeSiblings(),
                        k.is(this.element) ? t.call(this, k) : p(k, h(this)[k.getName()]))
                    }
                if (f) {
                    k = d;
                    for (g = 0; ; g++) {
                ...
                for (e = d; !e.equals(m); )
                    ...
                    e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? t.call(this, e) : p(e, h(this)[e.getName()]),
                    f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(),
                    f = d.getNext())),
                    e = f
            }
            a.moveToBookmark(c);
        ...
        function k(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph(); )
                !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = G(this, e, d),
                w(d, f));
            a.moveToBookmark(b)
        }
        function q(a) {
            ...
            for (var d, e; d = c.getNextParagraph(); )
                ...
                (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null  : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e),
                w(d, e)) : t.call(this, d));
            a.moveToBookmark(b)
        }
        function w(a, b) {
            var c = !b;
            c && (b = a.getDocument().createElement("div"),
            a.copyAttributes(b));
            var d = b && b.is("pre")
              , e = a.is("pre")
              , g = !d && e;
            if (d && !e) {
                ...
                g ? b = A(c ? [a.getHtml()] : f(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
        ...
        function t(a, b) {
            ...
            for (g in d)
                if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == n(g, d[g]))
                    b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g),
                    a.removeAttribute(g));
            for (var k in c)
                this._.definition.fullMatch && a.getStyle(k) != n(k, c[k], !0) || (f = f || !!a.getStyle(k),
                a.removeStyle(k));
            p(a, e, z[a.getName()]);
        ...
        function D(a) {
            for (var b = h(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e; )
                d = c.getItem(e),
                d.isReadOnly() || t.call(this, d, !0);
            for (var f in b)
                if (f != this.element)
                    for (c = a.getElementsByTag(f),
                    e = c.count() - 1; 0 <= e; e--)
                        d = c.getItem(e),
        ...
        function h(a) {
            ...
            if (c) {
                ...
                for (var d = 0; d < c.length; d++) {
                    var e = c[d], f, g;
                    "string" == typeof e ? f = e.toLowerCase() : (f = e.element ? e.element.toLowerCase() : a.element,
                    g = e.attributes);
                    e = b[f] || (b[f] = {});
                    if (g) {
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) {
                if (a instanceof CKEDITOR.dom.document)
                    return m.call(this, a.getSelection());
            ...
            remove: function(a) {
                if (a instanceof CKEDITOR.dom.document)
                    return m.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                ...
                case CKEDITOR.STYLE_INLINE:
                    for (var c = a.elements, d = 0, e; d < c.length; d++)
                        ...
                        this.type != CKEDITOR.STYLE_INLINE || e != a.block && e != a.blockLimit) {
                            ...
                            if (this.checkElementRemovable(e, !0, b))
                                return !0
                        }
                }
                return !1
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
        attachStyleStateChange: function(a, d) {
            ...
            b || (b = this._.styleStateChangeCallbacks = [],
            this.on("selectionChange", function(a) {
                for (var d = 0; d < b.length; d++) {
                    var g = b[d]
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
                if (q.type == CKEDITOR.NODE_ELEMENT) {
                    k.push(q);
                    if (!this.lastElement && (this.lastElement = q,
                    q.is(CKEDITOR.dtd.$object) || "false" == q.getAttribute("contenteditable")))
                        continue;if (q.equals(e))
                        break;
                    if (!l && (w = q.getName(),
                    "true" == q.getAttribute("contenteditable") ? l = q : !g && d[w] && (g = q),
                    a[w])) {
                        if (w = !g && "div" == w) {
                            a: {
                                w = q.getChildren();
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        isContextFor: function(a) {
            var d;
            return a in CKEDITOR.dtd.$block ? (d = this.contains(CKEDITOR.dtd.$intermediate) || this.root.equals(this.block) && this.block || this.blockLimit,
            !!d.getDtd()[a]) : !0
        },
        direction: function() {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function(a) {
            ...
            d.childNodes.length == b && (a >= c ? (g = e.createText(""),
            g.insertAfter(this)) : (a = e.createText(""),
            a.insertAfter(g),
            a.remove()));
            return g
        },
    ...
    (function() {
        function a(a, c, d) {
            ...
            l.equals(q.getPrevious()) ? (c.startOffset = c.startOffset - l.getLength() - a.getPrevious().getLength(),
            l = a.getNext()) : l.equals(a.getPrevious()) && (c.startOffset -= l.getLength(),
            l = a.getNext());
            ...
            createIterator: function() {
                ...
                return {
                    getNextRange: function(l) {
                        ...
                        if (k && 1 < a.length) {
                            if (!g)
                                for (var q = a.length - 1; 0 <= q; q--)
                                    d.unshift(a[q].createBookmark(!0));
                            if (l)
                                for (var w = 0; a[g + w + 1]; ) {
                                    var f = k.document;
                                    l = 0;
                                    ...
                                    for (f = f.getById(d[w + 1].startNode); ; ) {
                                        ...
                                        if (f.equals(q))
                                            l = 1;
                                        else if (c(q) || q.type == CKEDITOR.NODE_ELEMENT && q.isBlockBoundary())
                                            continue;break
                                    }
                                    if (!l)
                                        break;
                            ...
                            for (k.moveToBookmark(d.shift()); w--; )
                                q = a[++g],
                                q.moveToBookmark(d.shift()),
                                k.setEnd(q.endContainer, q.endOffset)
                        }
                        return k
                    }
                }
    ...
    (function() {
        ...
        function d(b) {
            ...
            if (c)
                for (var c = c.split(",").sort(function(a, b) {
                    ...
                    if (g = c[e],
                    d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"),
                    d[g]) {
                        b += "_" + c[e];
                        break
                    }
        ...
        function b(a, b) {
            g[a] || (CKEDITOR.document.appendStyleSheet(d(a)),
            g[a] = 1);
            b && b()
        }
        function c(a) {
            ...
            setUiColor: function(a) {
                ...
                return (this.setUiColor = function(a) {
                    ...
                    var c = CKEDITOR.skin.chameleon
                      , d = ""
                      , g = "";
                    "function" == typeof c && (d = c(this, "editor"),
                    g = 
                    c(this, "panel"));
                    a = [[q, a]];
                    e([b], d, a);
...
*/
        ...
        onLoad: function() {
                ...
                fileButton: function(b, a, d) {
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        c.onClick = function(c) {
                            var d = 
                            a["for"];
                            e && !1 === e.call(this, c) || (b.getContentElement(d[0], d[1]).submit(),
                            this.disable())
                        }
                        ;
                        b.on("load", function() {
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                ...
                eventProcessors: {
                    onChange: function(b, a) {
                        ...
                        b.on("load", function() {
                            for (var a = 
                            this._.children, b = this, c = 0; c < a.length; c++)
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, q, {
                ...
                reset: function() {
                    ...
                    m = this.formUnloadNumber = CKEDITOR.tools.addFunction(function() {
    ...
    (function() {
        ...
        function V(a) {
            ...
            !CKEDITOR.env.ie || CKEDITOR.env.quirks || CKEDITOR.env.edge || (a = "javascript:void(function(){" + encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.close();") + "}())",
            CKEDITOR.dom.element.createFromHtml('\x3ciframe frameBorder\x3d"0" class\x3d"cke_iframe_shim" src\x3d"' + a + '" tabIndex\x3d"-1"\x3e\x3c/iframe\x3e').appendTo(c.getParent()));
            d.unselectable();
            e.unselectable();
            return {
                element: b,
        ...
        function Z(a) {
            function b(b) {
                ...
                e == CKEDITOR.DIALOG_RESIZE_BOTH)
                    n = Math.max(d.minWidth || 0, G - g);
                if (e == CKEDITOR.DIALOG_RESIZE_HEIGHT || e == CKEDITOR.DIALOG_RESIZE_BOTH)
                    q = Math.max(d.minHeight || 0, H - h);
                a.resize(n, q);
                a._.moved || a.layout();
                b.data.preventDefault()
            }
            ...
            if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(), g, h, p, m, k, q, n = CKEDITOR.tools.addFunction(function(e) {
                    ...
                    d.$.getElementsByTagName("iframe").length && (q = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%;"\x3e\x3c/div\x3e'),
                    d.append(q));
                    ...
                    CKEDITOR.env.ie6Compat && (d = u.getChild(0).getFrameDocument(),
                    d.on("mousemove", b),
                    d.on("mouseup", c));
        ...
        function N(a) {
            ...
            e, f)
              , g = z[c];
            g ? g.show() : (f = ['\x3cdiv tabIndex\x3d"-1" style\x3d"position: ', CKEDITOR.env.ie6Compat ? "absolute" : "fixed", "; z-index: ", f, "; top: 0px; left: 0px; ", CKEDITOR.env.ie6Compat ? "" : "background-color: " + d, '" class\x3d"cke_dialog_background_cover"\x3e'],
            CKEDITOR.env.ie6Compat && (d = "\x3chtml\x3e\x3cbody style\x3d\\'background-color:" + d + ";\\'\x3e\x3c/body\x3e\x3c/html\x3e",
            f.push('\x3ciframe hidefocus\x3d"true" frameborder\x3d"0" id\x3d"cke_dialog_background_iframe" src\x3d"javascript:'),
            f.push("void((function(){" + 
            encodeURIComponent("document.open();(" + CKEDITOR.tools.fixDomain + ")();document.write( '" + d + "' );document.close();") + "})())"),
            f.push('" style\x3d"position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity\x3d0)"\x3e\x3c/iframe\x3e')),
            f.push("\x3c/div\x3e"),
            g = CKEDITOR.dom.element.createFromHtml(f.join("")),
            g.setOpacity(void 0 !== e ? e : .5),
            g.on("keydown", I),
            g.on("keypress", I),
            g.on("keyup", I),
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function d(a) {
                ...
                if (!(1 > b.length)) {
                    ...
                    do {
                        ...
                        if (d == c)
                            break
                    } while (a && !b[d].isFocusable());b[d].focus();
            ...
            function e(b) {
                if (l == CKEDITOR.dialog._.currentTop) {
                    ...
                    c) && l._.tabBarMode)
                        c = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], c) ? x.call(l) : A.call(l),
                        l.selectPage(c),
                        l._.tabs[c][0].focus(),
                        q = 1;
                        ...
                        if (13 == c)
                            c = b.data.getTarget(),
                            c.is("a", "button", "select", "textarea") || c.is("input") && "button" == c.$.type || ((c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c),
                            q = 1),
                            n = 1;
                        else if (27 == c)
                            (c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click, 0, c) : !1 !== this.fire("cancel", {
                                hide: !0
                            }).hide && this.hide(),
                            n = 1;
                        else
            ...
            if (g.onLoad)
                this.on("load", g.onLoad);
            if (g.onShow)
                this.on("show", g.onShow);
            if (g.onHide)
                this.on("hide", g.onHide);
            if (g.onOk)
            ...
            this.on("cancel", function(b) {
                t(function(c) {
                    if (c.isChanged())
                        return a.config.dialog_noConfirmCancel || confirm(a.lang.common.confirmCancel) || (b.data.hide = !1),
                        !0
                })
            }, this, null , 0);
            ...
            this.on("show", function() {
                ...
                a.config.dialog_startupFocusTab && b ? (l._.tabBarMode = !0,
                l._.tabs[l._.currentTabId][0].focus(),
                l._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length - 1,
                g.onFocus ? 
            ...
            this.parts.tabs.on("click", function(a) {
                var b = a.data.getTarget();
                b.hasClass("cke_dialog_tab") && (b = b.$.id,
                this.selectPage(b.substring(4, b.lastIndexOf("_"))),
                this._.tabBarMode && (this._.tabBarMode = !1,
                this._.currentFocusIndex = -1,
                d(1)),
                a.data.preventDefault())
            }, this);
        ...
        CKEDITOR.dialog.prototype = {
            ...
            move: function(a, b, c) {
                ...
                f || (f = CKEDITOR.document.getWindow().getScrollPosition(),
                a += f.x,
                b += f.y),
                e && (f = this.getSize(),
            ...
            show: function() {
                ...
                N(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop,
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    a.accessKey && (S(this, this, "CTRL+" + a.accessKey, ca, da),
            ...
            selectPage: function(a) {
                ...
                !1 !== this.fire("selectPage", {
                    ...
                    CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (K(e[1]),
                    e[1].show(),
                    setTimeout(function() {
                        K(e[1], 1)
                    }, 0)) : e[1].show();
            ...
            hidePage: function(a) {
                ...
                b && 1 != this._.pageCount && b.isVisible() && (a == this._.currentTabId && this.selectPage(x.call(this)),
                b.hide(),
                this._.pageCount--,
                this.updateStyle())
            },
            ...
            setState: function(a) {
                if (this.state != a) {
                    ...
                    if (a == CKEDITOR.DIALOG_STATE_BUSY) {
                        ...
                        a == CKEDITOR.DIALOG_STATE_IDLE && (this.parts.spinner && this.parts.spinner.hide(),
          ...
          , E = function(a, b, c, d, e) {
            if (c) {
                for (var f = 0, g; g = a[f]; f++) {
                    if (g.id == c)
                        return a.splice(f, 0, b),
                        b;
                    if (d && g[d] && (g = E(g[d], b, c, d, !0)))
                        return g
                }
                if (e)
                    return null 
        ...
        var J, z = {}, u, w = {}, Q = function(a) {
            ...
            (b = w[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1],
        ...
        , R = function(a) {
            var b = a.data.$.ctrlKey || a.data.$.metaKey
              ...
              , e = String.fromCharCode(a.data.$.keyCode);
            (b = w[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1],
            b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
            a.data.preventDefault()))
        }
        ...
        , ba = function(a) {
            for (var b in w) {
                for (var c = w[b], d = c.length - 1; 0 <= d; d--)
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        ...
                        b.requiredContent && !a.getParentEditor().filter.check(b.requiredContent) && (m.display = "none",
                        this.notAllowed = !0);
                        k.id = n;
                        var r = {};
                        ...
                        for (var l = k["class"] && k["class"].split ? k["class"].split(" ") : [], n = 0; n < l.length; n++)
                            l[n] && (r[l[n]] = 1);
                        l = 
                        [];
                        for (n in r)
                ...
                hbox: function(a, b, c, d, e) {
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var f = this._.children = b, g = e && e.widths || null , h = e && e.height || null , p, m = {
                            role: "presentation"
                        };
                    ...
                    return function() {
                        ...
                        for (f = 0; f < a.length; f++)
                            if ("function" == typeof a[f])
                                ...
                                break;
                        f < a.length && "string" == typeof a[f] && (c = a[f],
                        f++);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function(a, b) {
                ...
                if ("function" == typeof d)
                    c = 
                    this._.storedDialogs || (this._.storedDialogs = {}),
    ...
    (function() {
                ...
                if (c) {
                    ...
                    if (a == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (d = {}; a = f.getNextParagraph(); ) {
                            ...
                            c && e && !e.getCustomData("blockquote_moveout") && (b.push(e),
                        ...
                        for (d = {}; 0 < b.length; )
                            f = b.shift(),
                            c = f.getParent(),
                            f.getPrevious() ? f.getNext() ? (f.breakParent(f.getParent()),
                            e.push(f.getNext())) : f.remove().insertAfter(c) : f.remove().insertBefore(c),
                            c.getCustomData("blockquote_processed") || 
                            (e.push(c),
                            CKEDITOR.dom.element.setMarker(d, c, "blockquote_processed", !0)),
                            a.push(f);
                        CKEDITOR.dom.element.clearAllMarkers(d);
        ...
        CKEDITOR.plugins.add("blockquote", {
            init: function(g) {
                g.blockless || (g.addCommand("blockquote", m),
                g.ui.addButton && g.ui.addButton("Blockquote", {
    ...
    (function() {
        function r(b, a, c) {
            a.type || (a.type = "auto");
            if (c && !1 === b.fire("beforePaste", a) || !a.dataValue && a.dataTransfer.isEmpty())
                return !1;
        ...
        function y(b) {
            function a() {
                ...
                "beforepaste" == n.mainPasteEvent && (a.on("paste", function(a) {
                    ...
                    a.data.preventDefault(),
                    k(a),
                    f("paste") || b.openDialog("paste"))
                }),
                a.on("contextmenu", g, null , null , 0),
                a.on("beforepaste", function(b) {
            ...
            function h() {
                ...
                !CKEDITOR.env.quirks) {
                    ...
                    a.getType() == CKEDITOR.SELECTION_ELEMENT && (d = a.getSelectedElement()) && (c = a.getRanges()[0],
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    var k = 0
                      , c = c.getWindow();
                    CKEDITOR.env.webkit ? (e.append(m),
                    m.addClass("cke_editable"),
                    e.is("body") || (k = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent),
                    k = k.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(m);
                    m.setStyles({
                        position: "absolute",
                    ...
                    (k = m.getParent().isReadOnly()) ? (m.setOpacity(0),
                    m.setAttribute("contenteditable", !0)) : m.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");
                    b.on("selectionChange", f, null , null , 0);
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko)
                        q = e.once("blur", f, null , null , -100);
                    k && m.focus();
            ...
            function z() {
                ...
                a.lock();
                if (b.editable().fire(n.mainPasteEvent) && !f("paste"))
                    return a.unlock(),
                    !1;
                a.unlock();
                return !0
            ...
            function k(a) {
                ...
                c && n.canClipboardApiBeTrusted(d.dataTransfer, b) ? (a.data.preventDefault(),
                setTimeout(function() {
                    r(b, d)
                }, 0)) : l(a, function(a) {
            ...
            b.getClipboardData = function(a, d) {
                ...
                !1 === z() && (b.removeListener("paste", c),
                q && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e),
        ...
        function B(b, a) {
            ...
            a = a.replace(/<\/?div>/g, ""));
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "\x3cbr\x3e")),
            -1 < a.indexOf("\x3cbr\x3e\x3cbr\x3e") && (a = "\x3cp\x3e" + a.replace(/(<br>){2,}/g, function(a) {
                return c(a.length / 4)
            }) + "\x3c/p\x3e"));
            return C(b, a)
        }
        function D() {
            ...
            return {
                get: function(c) {
                    return "plain-text" == 
                    c ? a.plainText || (a.plainText = new CKEDITOR.filter("br")) : "semantic-content" == c ? ((c = a.semanticContent) || (c = new CKEDITOR.filter,
                    c.allow({
                        $1: {
                            elements: b(),
                            attributes: !0,
                    ...
                    c) : c ? new CKEDITOR.filter(c) : null 
                }
            }
        }
        function x(b, a, c) {
        ...
        function F(b) {
            ...
            b.on("contentDom", function() {
                ...
                f.attachListener(b, "dragstart", function() {
                    ...
                    CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (a.dragStartContainerChildCount = d ? g(d.startContainer) : null ,
                ...
                b.on("paste", function(a) {
                    ...
                    if (!a.data.dataValue) {
                        ...
                        if (g)
                            ...
                            g,
                            a.data.type = "html";
                        else if (g = c.getData("text/plain"))
                            a.data.dataValue = b.editable().transformPlainTextToHtml(g),
                            a.data.type = "text"
                    }
                }, null , null , 1);
                b.on("paste", function(a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        ...
                        for (l.setHtml(b); 1 == l.getChildCount() && (f = l.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") || f.hasClass("cke_contents")); )
                            l = h = f;
                        h && (b = h.getHtml().replace(/<br>$/i, ""))
                    }
                    CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b, 
                    f) {
                        return f.toLowerCase() in c ? (a.data.preSniffing = "html",
                        "\x3c" + f) : b
                    }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/, function(b, f) {
                        return f in c ? (a.data.endsWithEOL = 1,
                        "\x3c/" + f + "\x3e") : b
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function(b, a, c, d) {
                function e(b, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount())
                        return b = a.startContainer.getChild(a.startOffset - 1),
            ...
            getRangeAtDropPosition: function(b, a) {
                ...
                if (document.caretRangeFromPoint)
                    c = a.document.$.caretRangeFromPoint(d, 
                    e),
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                if (n.equals(a.editable()) || "html" == n.getName())
                                    return g && g.startContainer && !g.startContainer.equals(a.editable()) ? g : null ;
                                r = n.getClientRect();
        ...
        CKEDITOR.plugins.clipboard.dataTransfer = function(b, a) {
            ...
            a && (this.sourceEditor = a,
            this.setData("text/html", a.getSelectedHtml(1)),
            "Text" == p || this.getData("text/plain") || this.setData("text/plain", a.getSelection().getSelectedText()))
        }
        ;
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = 
        {
            getData: function(b) {
                ...
                (b = this._.bodyRegExp.exec(a)) && b.length && (a = b[1],
                a = a.replace(this._.fragmentRegExp, ""))) : "Text" == b && CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7) && (a = "");
                return a
            },
            ...
            _getImageFromClipboard: function() {
                ...
                if (this.$ && this.$.items && this.$.items[0])
                    try {
                        if ((b = this.$.items[0].getAsFile()) && b.type)
                            return b
                    } catch (a) {}
            }
        }
            ...
            proto: {
                ...
                onKeyDown: function(a, b) {
                    ...
                    case "prev":
                        ...
                        return c || b ? !1 : (this._.focusIndex = d.count(),
                        this.onKeyDown(a, 1));
                    case "click":
                    case "mouseup":
    ...
    (function() {
        function v(a, b, c, l, h) {
            ...
            var g = f[h];
            g || (g = f[h] = new CKEDITOR.ui.panel(b,l),
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                showBlock: function(a, b, c, l, h, g) {
                    ...
                    this._.blurSet || (CKEDITOR.event.useCapture = !0,
                    ...
                    CKEDITOR.env.iOS && (e.on("touchstart", function() {
                    ...
                    m.onEscape = CKEDITOR.tools.bind(function(a) {
                        if (this.onEscape && !1 === this.onEscape(a))
                            return !1
                    }, this);
                    CKEDITOR.tools.setTimeout(function() {
                        var a = CKEDITOR.tools.bind(function() {
                            ...
                            CKEDITOR.env.ie && (b = a = new CKEDITOR.dom.element(k.$.offsetParent),
                            "html" == b.getName() && (b = b.getDocument().getBody()),
                            "rtl" == b.getComputedStyle("direction") && (d = CKEDITOR.env.ie8Compat ? d - 2 * k.getDocument().getDocumentElement().$.scrollLeft : d - (a.$.scrollWidth - a.$.clientWidth)));
                            var a = k.getFirst(), f;
    ...
    CKEDITOR.plugins.add("menu", {
        ...
        beforeInit: function(g) {
            for (var h = g.config.menu_groups.split(","), p = g._.menuGroups = {}, n = g._.menuItems = {}, a = 0; a < h.length; a++)
                p[h[a]] = a + 1;
                    ...
                    for (var e = 0; e < m.length; e++) {
                        ...
                        if (l)
                            for (var k in l) {
                                ...
                                !f || f.command && !this.editor.getCommand(f.command).state || (f.state = l[k],
                                this.add(f))
                            }
                    }
                },
    ...
    CKEDITOR.plugins.add("resize", {
        init: function(b) {
            ...
            function k() {
                ...
                b.document && (b.document.removeListener("mousemove", f),
                b.document.removeListener("mouseup", 
                k))
            }
            var a = b.config
            ...
            if (!1 !== a.resize_enabled) {
                ...
                a.resize_dir) && a.resize_minHeight != a.resize_maxHeight, q = CKEDITOR.tools.addFunction(function(d) {
                    ...
                    b.document && (b.document.on("mousemove", f),
                    b.document.on("mouseup", k));
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                function c() {
                    var e = a.mode;
                    e && (e = this.modes[e] ? void 0 !== k[e] ? k[e] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                    e = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED : e,
                    this.setState(e),
                ...
                u = CKEDITOR.tools.addFunction(function(a) {
                    if (d.onkey)
                        return a = new CKEDITOR.dom.event(a),
                ...
                if (this.modes) {
                    ...
                    g && (g = a.getCommand(g)) && (g.on("state", function() {
                ...
                var q = this.name || this.command
                  , h = q;
                this.icon && !/\./.test(this.icon) && (h = this.icon,
                this.icon = null );
                f = {
                    id: m,
                    name: q,
            ...
            setState: function(a) {
                ...
                CKEDITOR.document.getById(this._.id + "_label").setText(a)) : a == CKEDITOR.TRISTATE_ON ? 
                b.setAttribute("aria-pressed", !0) : b.removeAttribute("aria-pressed"),
                !0) : !1
            },
            getState: function() {
                return this._.state
    ...
    (function() {
        function B(a) {
            ...
            function h(b) {
                ...
                for (e = 0; e < b.length; ++e)
                    d = b[e],
                    h = {},
                    "/" == d ? a.push(d) : CKEDITOR.tools.isArray(d) ? (c(h, CKEDITOR.tools.clone(d)),
                    a.push(h)) : d.items && (c(h, CKEDITOR.tools.clone(d.items)),
                    h.name = d.name,
                    a.push(h));
                return a
            }
        ...
        var C = {
            ...
            readOnly: 1,
            exec: function(a) {
                a.toolbox && (a.toolbox.focusCommandExecuted = !0,
                ...
                var d, g = function(c, h) {
                    ...
                    case CKEDITOR.SHIFT + 9:
                        for (; !b || !b.items.length; )
                            if (b = 9 == h ? (b ? b.next : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length - 1],
                            b.items.length)
                    ...
                    case r:
                        ...
                        while (b && !b.focus);b ? b.focus() : g(c, 9);
                        return !1;
                    case 40:
                    ...
                    case 38:
                        ...
                        while (b && !b.focus);b ? b.focus() : (d = 1,
                        g(c, CKEDITOR.SHIFT + 9),
                        d = 0);
                        return !1;
                    case 27:
                        return a.focus(),
                                    ...
                                    for (var x = 0; x < w.length; x++) {
                                        ...
                                        if (t) {
                                            ...
                                            if (t.type == CKEDITOR.UI_SEPARATOR)
                                                ...
                                                q ? e || (b.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),
                                                e = 1) : e && (b.push("\x3c/span\x3e"),
                                                e = 0);
                                                k && (z(k),
                                                k = 0);
                                                z(t)
                        ...
                        if (a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            a.addCommand("toolbarCollapse", {
                                ...
                                exec: function(b) {
                                    ...
                                    a.setAttribute("title", b.lang.toolbar.toolbarCollapse)) : (c.hide(),
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function(a, d, g) {
            ...
            if (g) {
                if (g = CKEDITOR.tools.search(c, function(a) {
                    ...
                    !g.groups && (g.groups = []);
                    if (d && 
                    (d = CKEDITOR.tools.indexOf(g.groups, d),
                    0 <= d)) {
        ...
        function q(a, d) {
            ...
            var v = CKEDITOR.tools.addFunction(l)
              , w = CKEDITOR.tools.addFunction(function(c, e) {
                ...
                case b ? 37 : 39:
                case CKEDITOR.SHIFT + 9:
                    return (b = CKEDITOR.document.getById(g + (c - 1))) || (b = CKEDITOR.document.getById(g + (k.list.length - 1))),
                    b.focus(),
                    !1;
                case 27:
                    return a.focus(),
    ...
    (function() {
        function q(b, d, a) {
            ...
            "wysiwyg" == b.mode && (d || (d = b.activeEnterMode),
            b.elementPath().isContextFor("p") || (d = CKEDITOR.ENTER_BR,
            a = 1),
            b.fire("saveSnapshot"),
                ...
                if (a = a || v(b)) {
                    ...
                    if (k && m) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            ...
                            if (e.is("li"))
                                h || p ? (h && p && a.remove(),
                                c[p ? "insertAfter" : "insertBefore"](e)) : c.breakParent(e);
                            else {
                                if (b)
                                    if (l.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"),
                                    q && e.setAttribute("dir", k),
                                    r && e.setAttribute("style", r),
                                    m && e.setAttribute("class", m),
                                    c.moveChildren(e)) : e = l.block,
                                    h || p)
                                        e[h ? "insertBefore" : "insertAfter"](a);
                                    else
                                        c.breakParent(a),
                                        e.insertAfter(a);
                                else if (c.appendBogus(!0),
                                h || p)
                    ...
                    if (k = a.splitBlock(n)) {
                        ...
                        b = k.wasEndOfBlock;
                        c ? (g = c.getParent(),
                        g.is("li") && (c.breakParent(g),
                        c.move(c.getNext(), 1))) : d && (g = d.getParent()) && g.is("li") && (d.breakParent(g),
                        g = d.getNext(),
                        a.moveToElementEditStart(g),
                        ...
                        if (l || b) {
                            if (d) {
                                ...
                                c && (e = c.clone());
                            e ? h && !e.is("li") && e.renameNode(n) : g && g.is("li") ? e = g : (e = f.createElement(n),
                            d && (p = d.getDirection()) && e.setAttribute("dir", p));
                            if (f = k.elementPath)
                                for (h = 0,
                                n = f.elements.length; h < n; h++) {
                                    g = f.elements[h];
                            ...
                            !CKEDITOR.env.ie || !l || b && d.getChildCount() || (a.moveToElementEditStart(b ? d : e),
                            a.select());
                            ...
                            ,
                            (g = e.next()) && 
                            g.type == CKEDITOR.NODE_ELEMENT && g.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? f.createElement("br") : f.createText(" ")).insertBefore(g)),
            ...
            enterBr: function(b, d, a, h) {
                if (a = a || v(b)) {
                    var f = a.document
                      ...
                      , l = m.block
                      , c = l && m.block.getName();
                    h || "li" != c ? (!h && k && w.test(c) ? (k = l.getDirection()) ? (f = f.createElement("div"),
                    f.setAttribute("dir", k),
                    f.insertAfter(l),
                    a.setStart(f, 
                    0)) : (f.createElement("br").insertAfter(l),
                    CKEDITOR.env.gecko && f.createText("").insertAfter(l),
                    a.setStartAt(l.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START : CKEDITOR.POSITION_AFTER_START)) : (b = "pre" == c && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"),
                    a.deleteContents(),
                    a.insertNode(b),
                    CKEDITOR.env.needsBrFiller ? (f.createText("﻿").insertAfter(b),
        ...
        CKEDITOR.plugins.add("entities", 
        {
            afterInit: function(b) {
                ...
                if (b = (b = b.dataProcessor) && b.htmlFilter) {
                    ...
                    c.entities_greek && e.push("Alpha,Beta,Gamma,Delta,Epsilon,Zeta,Eta,Theta,Iota,Kappa,Lambda,Mu,Nu,Xi,Omicron,Pi,Rho,Sigma,Tau,Upsilon,Phi,Chi,Psi,Omega,alpha,beta,gamma,delta,epsilon,zeta,eta,theta,iota,kappa,lambda,mu,nu,xi,omicron,pi,rho,sigmaf,sigma,tau,upsilon,phi,chi,psi,omega,thetasym,upsih,piv"),
    ...
    (function() {
        function g(a, c) {
            ...
            if (c)
                for (var b in c)
                    d.push(b + "\x3d" + encodeURIComponent(c[b]));
            else
                return a;
        ...
        function l(a, c, d, b) {
            if (b && b.length)
                for (var e, g = b.length; g--; )
                    if (e = b[g],
                    "hbox" != e.type && "vbox" != e.type && "fieldset" != e.type || l(a, c, d, e.children),
                    e.filebrowser)
                        ...
                        void 0 === f && (f = a.config["filebrowser" + k(c) + "UploadUrl"],
                            ...
                            e.onClick = function(a) {
                                ...
                                if (n.call(b, a)) {
                                    ...
                                    if (b = new CKEDITOR.dom.element(a.$.form))
                                        (a = 
                                        b.$.elements.ckCsrfToken) ? a = new CKEDITOR.dom.element(a) : (a = new CKEDITOR.dom.element("input"),
                                        a.setAttributes({
                                            name: "ckCsrfToken",
                                            type: "hidden"
                                        }),
        ...
        c) {
            ...
            if ("function" != typeof c || !1 !== c.call(this._.filebrowserSe))
                if (!e || !1 !== e.call(this._.filebrowserSe, a, c))
                    if ("string" == typeof c && c && alert(c),
                    a && (b = this._.filebrowserSe,
                    d = b.getDialog(),
                    b = b.filebrowser.target || null ))
                        if (b = b.split(":"),
                        e = d.getContentElement(b[0], b[1]))
                            e.setValue(a),
                            d.selectPage(b[0])
        }
              ...
              , t = function() {
                ...
                return function(d) {
                    if (k = a.editable()) {
                        ...
                        m ? (q + r <= c.top ? e("top") : q + r > h.height - c.bottom ? e("pin") : e("bottom"),
                        d = h.width / 2,
                        d = l.floatSpacePreferRight ? "right" : 0 < c.left && c.right < h.width && c.width > n.width ? "rtl" == l.contentsLangDirection ? 
                        "right" : "left" : d - c.left > c.right - d ? "left" : "right",
                        n.width > h.width ? (d = "left",
                        f = 0) : (f = "left" == d ? 0 < c.left ? c.left : 0 : c.right < h.width ? h.width - c.right : 0,
                        f + n.width > h.width && (d = "left" == d ? "right" : "left",
                        f = 0)),
                        b.setStyle(d, w(("pin" == m ? u : p) + f + ("pin" == m ? 0 : "left" == d ? v : -v)))) : (m = "pin",
                        e("pin"),
                        t(d))
                    }
                }
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({
                ...
                proto: {
                    add: function(a, b, c) {
                        ...
                        this._.started || (this._.started = 1,
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                setValue: function(a, b) {
                    ...
                    d && (a || b ? d.removeClass("cke_combo_inlinelabel") : (b = this.label,
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("horizontalrule", {
            init: function(a) {
                a.blockless || (a.addCommand("horizontalrule", b),
                a.ui.addButton && a.ui.addButton("HorizontalRule", {
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        proto: {
            ...
            openTagClose: function(b, a) {
                ...
                a ? (this._.output.push(this.selfClosingEnd),
                c && c.breakAfterClose && (this._.needsSpace = c.needsSpace)) : (this._.output.push("\x3e"),
            ...
            attribute: function(b, a) {
                "string" == typeof a && (this.forceSimpleAmpersand && (a = a.replace(/&amp;/g, "\x26")),
            ...
            closeTag: function(b) {
                ...
                a && a.breakAfterClose && (this.lineBreak(),
                this._.needsSpace = a.needsSpace);
        ...
        function m(a) {
            function f(a) {
                ...
                g.attachListener(g, "keyup", function() {
                    ...
                    b && (1 != d.count() || d.getItem(0).getCustomData("retain") || d.getItem(0).remove(1),
                    b = !1)
                })
            }
            var b = this.editor
            ...
            CKEDITOR.tools.setTimeout(function() {
                ...
                b.fire("contentDom");
                this._.isPendingFocus && (b.focus(),
                this._.isPendingFocus = !1);
                setTimeout(function() {
                    b.fire("dataReady")
                }, 0)
            }, 0, this)
        ...
        function n(a) {
            function f() {
                ...
                a.editable().attachListener(a, "selectionChange", function() {
                    ...
                    d && (c && (c.detachEvent("onresizestart", b),
                    c = null ),
            ...
            if (CKEDITOR.env.gecko)
                ...
                CKEDITOR.env.ie && 11 > CKEDITOR.env.version && a.config.disableObjectResizing && f(a)
        }
        function p() {
            var a = [];
            ...
            proto: {
                setData: function(a, f) {
                    ...
                    if (f)
                        ...
                        d ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a),
                        /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"),
                        /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"),
                        ...
                        CKEDITOR.env.gecko && (a = a.replace(/<body/, '\x3cbody contenteditable\x3d"true" '),
                        2E4 > CKEDITOR.env.version && (a = a.replace(/<body[^>]*>/, "$\x26\x3c!-- cke-content-start --\x3e")));
                ...
                detach: function() {
                    ...
                    b && b.getParent() ? (b.clearCustomData(),
                    (a = b.removeCustomData("onResize")) && a.removeListener(),
                    b.remove()) : CKEDITOR.warn("editor-destroy-iframe")
                }
            }
        })
    })();
                ...
                function a(a) {
                    ...
                    if (d) {
                        ...
                        d.on("refresh", function(d) {
                            var c = e(b);
                            c && (c = f(c),
                            this.setState(c == a ? CKEDITOR.TRISTATE_ON : "right" == a || "left" == a ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED),
                            d.cancel())
                        })
                    }
                }
                b.plugins.image2 || (a("left"),
                a("right"),
                a("center"),
                a("block"))
            }
                    ...
                    for (var n = new CKEDITOR.dom.walker(f), c; c = n.next(); )
                        if (c.type == CKEDITOR.NODE_ELEMENT)
                            ...
                            c.getDirection())
                                ...
                                if (d)
                                    for (var g = "ltr" == b.data.dir ? ["_rtl", ""] : ["", "_rtl"], h = 0; h < d.length; h++)
                                        c.hasClass(d[h] + g[0]) && (c.removeClass(d[h] + g[0]),
                                        c.addClass(d[h] + g[1]));
                        ...
                        (function(a, b) {
                            ...
                            for (c in b.jobs)
                                e.on("exec", function(d) {
                                    d.data.done || (a.fire("lockSnapshot"),
                                    b.execJob(a, c) && (d.data.done = 
                                    !0),
                                    a.fire("unlockSnapshot"),
                                    CKEDITOR.dom.element.clearAllMarkers(b.database))
                                }, this, null , c),
                                e.on("refresh", function(d) {
    ...
    (function() {
        function w(c) {
            function f(b) {
                ...
                for (a = e.getCustomData("listarray_index") + 1; a < k.length && k[a].indent > n; a++)
                    k[a].indent += g;
                e = CKEDITOR.plugins.list.arrayToList(k, q, null , c.config.enterMode, b.getDirection());
                if (!l.isIndent) {
                    var f;
                    if ((f = b.getParent()) && f.is("li"))
                        for (var g = e.listNode.getChildren(), r = [], m, a = g.count() - 1; 0 <= a; a--)
                ...
                if (r && r.length)
                    for (a = 0; a < r.length; a++) {
                        for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName() in p; )
                            CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(d.document.createText(" ")),
                            b.append(m);
                        b.insertAfter(f)
                    }
            ...
            for (var l = this, q = this.database, p = this.context, n = c.getSelection(), n = (n && n.getRanges()).createIterator(), d; d = n.getNextRange(); ) {
                ...
                if (!b) {
                    ...
                    h && h.type == CKEDITOR.NODE_ELEMENT && h.getName() in p && (d.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
                    d.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                    b = h)
                }
                b && d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in p && (h = new CKEDITOR.dom.walker(d),
                h.evaluator = t,
                d.startContainer = h.next());
                b && d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in 
                p && (h = new CKEDITOR.dom.walker(d),
                h.evaluator = t,
                ...
                function f(c) {
                    ...
                    function(f) {
                        if ("wysiwyg" == c.mode && f.data.keyCode == this.indentKey) {
                            ...
                            !n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c.elementPath(), n) || (c.execCommand(this.relatedGlobal),
                            f.cancel())
                        }
                    }, this);
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("link", {
            ...
            init: function(c) {
                ...
                c.on("doubleclick", function(a) {
                    ...
                    b.isReadOnly() || (b.is("a") ? (a.data.dialog = !b.getAttribute("name") || b.getAttribute("href") && b.getChildCount() ? "link" : "anchor",
                    a.data.link = 
        ...
        CKEDITOR.plugins.link = {
            ...
            getEditorAnchors: function(c) {
                for (var b = c.editable(), a = b.isInline() && !c.plugins.divarea ? c.document : b, b = a.getElementsByTag("a"), a = a.getElementsByTag("img"), f = [], e = 0, d; d = b.getItem(e++); )
                    (d.data("cke-saved-name") || d.hasAttribute("name")) && f.push({
            ...
            getLinkAttributes: function(c, b) {
                ...
                case "email":
                    ...
                    case "encode":
                        ...
                        "encode" == a ? (a = ["javascript:void(location.href\x3d'mailto:'+", q(e)],
                        d && a.push("+'", p(d), "'"),
                        a.push(")")) : a = ["mailto:", e, d];
                        break;
                    default:
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function(c) {
                ...
                if (b && (f = b.getSelectedElement()) && (f.getChildCount() ? f.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f)))
                    f.remove(1);
    ...
    (function() {
        function I(b, m, e) {
            ...
            for (k = 0; k < g.length; k++)
                h = g[k].getCustomData("listarray_index"),
                f[h].indent = -1;
        ...
        function F(b) {
            function m(e) {
                ...
                c && c.type == CKEDITOR.NODE_ELEMENT && c.is(b.getName()) && (E(b, c, null , !e),
                b.remove(),
                b = c)
            }
            m();
        ...
        function C(b, m, e) {
            ...
            d && (c = A(d)) && (g.contains(d) ? (E(c, d.getParent(), d),
            c.remove()) : g.append(c));
            ...
            listToArray: function(b, m, e, c, f) {
                ...
                for (var g = 0, k = b.getChildCount(); g < k; g++) {
                    ...
                    if ("li" == h.$.nodeName.toLowerCase()) {
                        ...
                        f ? d.grandparent = f : (d.grandparent = b.getParent(),
                        d.grandparent && "li" == d.grandparent.$.nodeName.toLowerCase() && (d.grandparent = d.grandparent.getParent()));
            ...
            arrayToList: function(b, m, e, c, f) {
                ...
                for (var g, k = b[e].parent.getDocument(), h = new CKEDITOR.dom.documentFragment(k), d = null , a = e, p = Math.max(b[e].indent, 0), l = null , q, n, t = c == CKEDITOR.ENTER_P ? "p" : "div"; ; ) {
                    ...
                    if (r.indent == p) {
                        ...
                        d.getName() || (d = b[a].parent.clone(!1, 1),
                    ...
                    r.indent && !e && g) {
                        v[g.getName()] ? (l = r.element.clone(!1, !0),
                        q != g.getDirection(1) && l.setAttribute("dir", q)) : l = new CKEDITOR.dom.documentFragment(k);
                        ...
                        for (g = 0; g < B; g++)
                            ...
                            H(w) && 1 < B)
                                ...
                                x && (n.append(x),
                                x = null ),
                                n.append(w.clone(1, 1))) : l.append(w.clone(1, 1));
                        x && ((n || l).append(x),
                        x = null );
                        l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && a != b.length - 1 && (CKEDITOR.env.needsBrFiller && 
                        (q = l.getLast()) && q.type == CKEDITOR.NODE_ELEMENT && q.is("br") && q.remove(),
                        (q = l.getLast(u)) && q.type == CKEDITOR.NODE_ELEMENT && q.is(CKEDITOR.dtd.$block) || l.append(k.createElement("br")));
                        ...
                        return null ;
                    n = null ;
                    if (b.length <= a || Math.max(b[a].indent, 0) < p)
                        break
                }
                if (m)
                    for (b = h.getFirst(); b; ) {
                        if (b.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(m, b),
                        b.getName() in CKEDITOR.dtd.$listItem && (e = b,
                        k = f = c = void 0,
                        c = e.getDirection()))) {
                            for (f = 
                            e.getParent(); f && !(k = f.getDirection()); )
                                f = f.getParent();
            ...
            exec: function(b) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    ...
                    if (f.getFirst(u)) {
                        ...
                        m.enterMode == 
                        CKEDITOR.ENTER_BR ? f.appendBogus() : c[0].fixBlock(1, m.enterMode == CKEDITOR.ENTER_P ? "p" : "div"),
                        e.selectRanges(c)
                }
                        ...
                        if (!d.getCustomData("list_block")) {
                            ...
                            for (var l = b.elementPath(d), a = l.elements, p = 0, l = l.blockLimit, q, n = a.length - 1; 0 <= n && (q = a[n]); n--)
                                if (v[q.getName()] && l.contains(q)) {
                                    ...
                                    f.push(a),
                                    CKEDITOR.dom.element.setMarker(k, q, "list_group_object", a));
                                    p = 1;
                                    break
                                }
                            p || (p = l,
                            p.getCustomData("list_group_object_" + 
                            h) ? p.getCustomData("list_group_object_" + h).contents.push(d) : (a = {
                                root: p,
                                contents: [d]
                            },
                            CKEDITOR.dom.element.setMarker(k, p, "list_group_object_" + h, a),
                            f.push(a)))
                        }
                }
                for (q = []; 0 < f.length; )
                    ...
                    this.state == CKEDITOR.TRISTATE_OFF)
                        if (v[a.root.getName()]) {
                            ...
                            for (d = 0; d < h.contents.length; d++)
                                n = h.contents[d],
                                (n = n.getAscendant("li", !0)) && !n.getCustomData("list_item_processed") && (l.push(n),
                                CKEDITOR.dom.element.setMarker(a, n, "list_item_processed", 
                                !0));
                            for (var n = h.root.getDocument(), t = void 0, r = void 0, d = 0; d < l.length; d++) {
                                var y = l[d].getCustomData("listarray_index")
                                  , t = p[y].parent;
                                t.is(this.type) || (r = n.createElement(this.type),
                                t.copyAttributes(r, {
                                    start: 1,
                                    type: 1
                                }),
                            ...
                            h = [];
                            1 == l.length && l[0].equals(g.root) && (a = c.createElement("div"),
                            ...
                            if (!(1 > h.length)) {
                                ...
                                for (t = d = void 0; h.length; )
                                    ...
                                    r = d,
                                    r.is("pre") || L.test(r.getName()) || "false" == r.getAttribute("contenteditable") ? d.appendTo(t) : (d.copyAttributes(t),
                                    a && d.getDirection() && (t.removeStyle("direction"),
                        ...
                        this.state == CKEDITOR.TRISTATE_ON && v[a.root.getName()] && I.call(this, b, a, k);
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist",
            init: function(b) {
                b.blockless || (b.addCommand("numberedlist", new B("numberedlist","ol")),
                ...
                b.on("key", function(m) {
                    ...
                    if ("wysiwyg" == b.mode && e in {
                        ...
                        if (f && f.collapsed) {
                            ...
                            if (k) {
                                var a;
                                (a = g.contains(v)) && f.checkBoundaryOfElement(a, CKEDITOR.START) && (a = a.getParent()) && a.is("li") && (a = A(a)) ? (c = a,
                                a = a.getPrevious(u),
                                e.moveToPosition(a && z(a) ? a : c, CKEDITOR.POSITION_BEFORE_START)) : (d.range.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
                                d.range.setEnd(f.startContainer, f.startOffset),
                                (a = d.previous()) && a.type == CKEDITOR.NODE_ELEMENT && (a.getName() in v || a.is("li")) && (a.is("li") || (d.range.selectNodeContents(a),
                                d.reset(),
                                d.evaluator = G,
                                a = d.previous()),
                                c = a,
                                ...
                                if (c)
                                    ...
                                    var p = g.contains(v);
                                    p && f.checkBoundaryOfElement(p, CKEDITOR.START) && (c = p.getFirst(u),
                                    f.checkBoundaryOfElement(c, CKEDITOR.START) && (a = p.getPrevious(u),
                                    A(c) ? a && (f.moveToElementEditEnd(a),
                                    f.select()) : b.execCommand("outdent"),
                                    m.cancel()))
                                }
                            } else if (c = g.contains("li")) {
                                if (d.range.setEndAt(h, CKEDITOR.POSITION_BEFORE_END),
                                k = (h = c.getLast(u)) && 
                                G(h) ? h : c,
                                g = 0,
                                (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in v && a.equals(h) ? (g = 1,
                                a = d.next()) : f.checkBoundaryOfElement(k, CKEDITOR.END) && (g = 2),
                                g && a) {
                                    f = f.clone();
                                    f.moveToElementEditStart(a);
                                    if (1 == g && (e.optimize(),
                                    !e.startContainer.equals(c))) {
                                        for (c = e.startContainer; c.is(CKEDITOR.dtd.$inline); )
                                            p = c,
                                            c = c.getParent();
                                        p && e.moveToPosition(p, CKEDITOR.POSITION_AFTER_END)
                                    }
                                    2 == g && (e.moveToPosition(e.endPath().block, CKEDITOR.POSITION_BEFORE_END),
                                ...
                                (a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.is(v) && (a = a.getFirst(u),
                                g.block && f.checkStartOfBlock() && f.checkEndOfBlock() ? (g.block.remove(),
                                f.moveToElementEditStart(a),
                                f.select()) : A(a) ? (f.moveToElementEditStart(a),
                                f.select()) : (f = f.clone(),
                                f.moveToElementEditStart(a),
                                C(b, e, f)),
                                m.cancel());
    ...
    (function() {
        ...
        function la(a) {
            ...
            v(d, {
                ...
                place: function() {
                    ...
                    p.equals(c) ? (m.left = b.scroll.x,
                    m.right = -b.scroll.x,
                    m.width = "") : (m.left = 
                    l.size.left - l.size.margin.left + b.scroll.x - (a.inInlineMode ? b.editable.left + b.editable.border.left : 0),
                    m.width = l.size.outerWidth + l.size.margin.left + l.size.margin.right + b.scroll.x,
                    m.right = "");
                    ...
                    d.is(C) || q(m.top, 
                    b.scroll.y - 15, b.scroll.y + 5) ? (m.top = a.inInlineMode ? 0 : b.scroll.y,
                    this.look(C)) : d.is(D) || q(m.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (m.top = a.inInlineMode ? b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1,
                    this.look(D)) : (a.inInlineMode && (m.top -= b.editable.top + b.editable.border.top),
                    this.look(x));
                    a.inInlineMode && (m.top--,
                    m.top += b.editable.scroll.top,
                    m.left += b.editable.scroll.left);
                    for (var n in m)
                        m[n] = CKEDITOR.tools.cssLength(m[n]);
                    this.setStyles(m)
                },
                look: function(a) {
                    if (this.oldLook != 
        ...
        function S(a, c, d) {
            ...
            t.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(J) : (f = (f = P(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode,
            f = new R(K[f],a.doc),
                ...
                exec: function() {
                    ...
                    return function(b) {
                        ...
                        if (!aa(a, b) && b && !b.equals(a.editable) && !b.contains(a.editable)) {
                            ...
                            e = w(a, b, !c);
                            var f;
                            n(e) && e.is(a.triggers) && e.is(ma) && (!w(a, e, !c) || (f = w(a, e, !c)) && n(f) && f.is(a.triggers)) ? d(e) : (f = O(a, b),
                            n(f) && (w(a, f, !c) ? (b = w(a, f, !c)) && n(b) && b.is(a.triggers) && d(f) : d(f)))
                        }
                    }
                }()
            }
        ...
        function ca(a) {
            ...
            if (!n(c) || u(c) || !L(a, c))
                return null ;
            r(a, c);
            return !f && 0 <= c.size.top && q(d.y, 0, c.size.top + e) ? (a = a.inInlineMode || 0 === b.scroll.y ? C : x,
            new z([null , c, I, M, a])) : f && c.size.bottom <= b.pane.height && q(d.y, c.size.bottom - e, b.pane.height) ? (a = a.inInlineMode || q(c.size.bottom, b.pane.height - e, b.pane.height) ? D : x,
            new z([c, null , da, M, a])) : null 
        }
        function ea(a) {
            var c = a.mouse
              , d = a.view
            ...
            e.size.bottom - b, e.size.bottom + 1))
                ...
                return null ;
            if (u(e) || na(a, e, h) || e.getParent().is(fa))
                return null ;
            var g = w(a, e, !h);
            if (g) {
                if (g && g.type == CKEDITOR.NODE_TEXT)
                    return null ;
                if (n(g)) {
                    if (u(g) || !L(a, g) || g.getParent().is(fa))
                        return null ;
                    f = [g, e][h ? "reverse" : "concat"]().concat([T, M])
                }
            } else
                e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? (H(a),
                h && q(c.y, e.size.bottom - b, d.pane.height) && q(e.size.bottom, d.pane.height - b, d.pane.height) ? k = D : q(c.y, 0, e.size.top + b) && (k = C)) : k = x,
                f = [null , e][h ? "reverse" : 
                "concat"]().concat([h ? da : I, M, k, e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant)) ? h ? D : C : x]);
            return 0 in f ? new z(f) : null 
        }
        function U(a, c, d, b) {
            for (var e = c.getDocumentPosition(), f = {}, k = {}, h = {}, g = {}, l = y.length; l--; )
                f[y[l]] = parseInt(c.getComputedStyle.call(c, "border-" + y[l] + "-width"), 10) || 0,
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function(a) {
                ...
                a.on("contentDom", function() {
                    ...
                    la.call(this, b),
                    N(b),
                    d.attachListener(a, "beforeUndoImage", 
                    function() {
                        b.line.detach()
                    }),
                    d.attachListener(a, "beforeGetData", function() {
                        b.line.wrap.getParent() && (b.line.detach(),
                        a.once("getData", function() {
                            b.line.attach()
                        }, null , null , 1E3))
                    }, null , null , 0),
                    d.attachListener(b.inInlineMode ? g : g.getWindow().getFrame(), "mouseout", function(c) {
                        if ("wysiwyg" == a.mode)
                            if (b.inInlineMode) {
                                ...
                                var e = b.view.editable
                                  , f = b.view.scroll;
                                d > e.left - f.x && d < e.right - f.x && c > e.top - f.y && c < e.bottom - f.y || (clearTimeout(k),
                                k = null ,
                                b.line.detach())
                            } else
                                clearTimeout(k),
                    ...
                    d.attachListener(b.inInlineMode ? d : g, "mousemove", function(c) {
                        ...
                        if ("wysiwyg" == a.mode && !a.readOnly && !k) {
                            ...
                            k = setTimeout(function() {
                                ...
                                ha(b, !0)) && ((b.trigger = ca(b) || ea(b) || ia(b)) && !aa(b, b.trigger.upper || b.trigger.lower) ? b.line.attach().place() : (b.trigger = null ,
                                b.line.detach()),
                                f = !1)
                            }, 30)
                        }
                    ...
                    d.attachListener(l, "scroll", function() {
                        "wysiwyg" == a.mode && (b.line.detach(),
                        t.webkit && (b.hiddenMode = 1,
                        clearTimeout(e),
                    ...
                    a.on("loadSnapshot", function() {
                        ...
                        for (f in {
                            ...
                            for (c = a.document.getElementsByTag(f),
                            e = c.count(); e--; )
        ...
        var ha = function() {
          ...
          , ia = function() {
            function a(a) {
                ...
                if (!n(b) || b.contains(a.editable) || b.isReadOnly())
                    return null ;
                k = pa(a, function(a, b) {
                    return !b.equals(a)
                }, function(a, b) {
                ...
                r(a, e);
                r(a, f);
                if (!q(a.mouse.y, e.size.top, f.size.bottom))
                    return null ;
                for (var b = Number.MAX_VALUE, h, g, l, p; f && !f.equals(e) && (g = e.getNext(a.isRelevant)); )
                    ...
                    e = g,
                    r(a, e);
                if (!l || !p || !q(a.mouse.y, l.size.top, p.size.bottom))
                    return null ;
                k.upper = l;
                k.lower = p;
                return k.set(T, 8)
    ...
    (function() {
        function n(a) {
            ...
            for (var e = [], f = ["style", "className"], b = 0; b < f.length; b++) {
                ...
                c && (c = new CKEDITOR.dom.element(c),
        ...
        function v(a) {
            if (!a.editable().isInline()) {
                ...
                for (f in e) {
                    var b = e[f];
                    "wysiwyg" != b.mode || b.readOnly || (b = b.document.getBody(),
                    ...
                    a.addCommand("maximize", {
                        ...
                        exec: function() {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                CKEDITOR.env.webkit && (h.setStyle("display", "inline"),
                                setTimeout(function() {
                            ...
                            this.toggleState();
                            if (d = this.uiItems[0])
                                g = this.state == CKEDITOR.TRISTATE_OFF ? f.maximize.maximize : f.maximize.minimize,
                                d = CKEDITOR.document.getById(d._.id),
                                d.getChild(1).setHtml(g),
                                d.setAttribute("title", g),
                                d.setAttribute("href", 'javascript:void("' + 
                                g + '");');
                            "wysiwyg" == a.mode ? l ? (CKEDITOR.env.gecko && v(a),
                            a.getSelection().selectRanges(l),
                            (k = a.getSelection().getStartElement()) && k.scrollIntoView(!0)) : c.$.scrollTo(m.x, m.y) : (l && (k.selectionStart = l[0],
                            k.selectionEnd = l[1]),
                            k.scrollLeft = m[0],
                            k.scrollTop = m[1]);
                            l = m = null ;
            ...
            removeformat: {
                exec: function(a) {
                    ...
                    , c; c = n.getNextRange(); ) {
                        ...
                        if (d)
                            for (k(d),
                            b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d); )
                                if (b.isReadOnly()) {
                                    ...
                                    "img" == b.getName() && b.data("cke-realelement") || !f(a, b) || (h.test(b.getName()) ? 
                                    b.remove(1) : (b.removeAttributes(e),
            ...
            init: function(a) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    a.addMode("source", function(e) {
                        ...
                        CKEDITOR.env.ie && (b.attachListener(a, "resize", d, b),
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        init: function(a) {
            ...
            a.contextMenu && a.addMenuItems && (a.contextMenu.addListener(function(b, d) {
                var e = 
                a.scayt, k, l;
                e && (l = e.getSelectionNode()) && (k = c.menuGenerator(a, l),
                e.showBanner("." + a.contextMenu._.definition.panel.className.split(" ").join(" .")));
                return k
            }),
        ...
        bindEvents: function(a) {
                ...
                b.attachListener(b, "focus", function(b) {
                    ...
                    if ((d || b) && a._.savedSelection) {
                        ...
                        for (var f = 0; f < b.length; f++)
                            h = b[f],
                            "string" === typeof h.startContainer.$.nodeValue && (c = h.startContainer.getText().length,
                            (c < h.startOffset || c < h.endOffset) && a.unlockSelection(!1))
                    }
                }, this, null , -10)
            }
              , g = function() {
            ...
            a.on("beforeCommandExec", function(b) {
                var d = a.scayt
                  ...
                  , f = !1
                  , g = !0;
                b.data.name in c.options.disablingCommandExec && "wysiwyg" == a.mode ? d && (c.destroy(a),
                a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !== b.data.name && 
                "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name && "cut" !== b.data.name && "language" !== b.data.name || !d || ("cut" === b.data.name && (g = !1,
                f = !0),
                "language" === b.data.name && (e = (e = a.plugins.language.getCurrentLangElement(a)) && e.$,
                f = !0),
            ...
            a.on("readOnly", function(b) {
                var d;
                b && (d = a.scayt,
                !0 === b.editor.readOnly ? d && d.fire("removeMarkupInDocument", {}) : d ? d.fire("startSpellCheck, startGrammarCheck") : "wysiwyg" == b.editor.mode && !0 === c.state.scayt[b.editor.name] && (c.createScayt(a),
            ...
            a.on("reloadMarkupScayt", function(b) {
                ...
                setTimeout(function() {
                    ...
                    b.removeMarkupInSelectionNode(d),
                    b.fire("startSpellCheck, startGrammarCheck"))
                }, b.data && 
                b.data.timeout || 0)
            });
        ...
        parseConfig: function(a) {
            ...
            if (void 0 === a.config.scayt_minWordLength || "number" != typeof a.config.scayt_minWordLength || 1 > a.config.scayt_minWordLength)
            ...
            if ("string" === typeof a.config.scayt_uiTabs && 3 === a.config.scayt_uiTabs.split(",").length) {
                ...
                CKEDITOR.tools.search(a.config.scayt_uiTabs, function(a) {
                    1 === Number(a) || 0 === Number(a) ? (b.push(!0),
                    d.push(Number(a))) : b.push(!1)
                });
            ...
            a.config.scayt_srcUrl = c + "//svc.webspellchecker.net/spellcheck31/lf/scayt3/ckscayt/ckscayt.js");
        ...
        addRule: function(a) {
            ...
            d = a.dataProcessor
              ...
              , g = function(b) {
                if (a.scayt && (b.hasAttribute(c.options.data_attribute_name) || b.hasAttribute(c.options.problem_grammar_data_attribute)))
                    return !1
            }
              , h = function(b) {
                var d = !0;
            ...
            if (0 < c.length && "no_any_suggestions" !== c[0])
                if (d)
                    for (d = 0; d < c.length; d++) {
                        ...
                        "on" === a.config.scayt_moreSuggestions && (a.addMenuItem("scayt_moresuggest", {
                    ...
                    for (d = 0; d < c.length; d++)
                        k = "grayt_suggest_" + CKEDITOR.plugins.scayt.suggestions[d].replace(" ", "_"),
                        a.addCommand(k, this.createCommand(CKEDITOR.plugins.scayt.suggestions[d], 
                        f, g)),
                        a.addMenuItem(k, {
                            label: c[d],
                            command: k,
        ...
        menuGenerator: function(a, c) {
            ...
            e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, h)) : k && (b = b.grayt,
            ...
            d.fire("getGrammarSuggestionsList", {
                lang: g,
                phrase: e
            }),
            e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, 
            h));
            if (h && "off" == a.config.scayt_contextCommands)
                return e;
            for (var l in b)
                h && -1 == CKEDITOR.tools.indexOf(f, l.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[l] = "undefined" != typeof b[l].state ? b[l].state : CKEDITOR.TRISTATE_OFF,
    ...
    CKEDITOR.plugins.scayt = {
        ...
        replaceOldOptionsNames: function(a) {
            for (var c in a)
                c in this.backCompatibilityMap && (a[this.backCompatibilityMap[c]] = a[c],
                delete a[c])
        },
        createScayt: function(a) {
            ...
            this.loadScaytLibrary(a, function(a) {
                ...
                a.config.scayt_serviceProtocol && (e.service_protocol = a.config.scayt_serviceProtocol),
                a.config.scayt_serviceHost && (e.service_host = a.config.scayt_serviceHost),
                a.config.scayt_servicePort && (e.service_port = a.config.scayt_servicePort),
                a.config.scayt_servicePath && (e.service_path = a.config.scayt_servicePath),
                "boolean" === typeof a.config.scayt_ignoreAllCapsWords && (e["ignore-all-caps-words"] = a.config.scayt_ignoreAllCapsWords),
                "boolean" === typeof a.config.scayt_ignoreDomainNames && 
                (e["ignore-domain-names"] = a.config.scayt_ignoreDomainNames),
                "boolean" === typeof a.config.scayt_ignoreWordsWithMixedCases && (e["ignore-words-with-mixed-cases"] = a.config.scayt_ignoreWordsWithMixedCases),
                "boolean" === typeof a.config.scayt_ignoreWordsWithNumbers && (e["ignore-words-with-numbers"] = a.config.scayt_ignoreWordsWithNumbers),
                e = new SCAYT.CKSCAYT(e,function() {}
                ,function() {}
                ),
                ...
                a.scayt = e,
                a.fire("scaytButtonState", a.readOnly ? CKEDITOR.TRISTATE_DISABLED : CKEDITOR.TRISTATE_ON)) : d.state.scayt[a.name] = !1
            })
        },
        destroy: function(a) {
        ...
        loadScaytLibrary: function(a, c) {
            var d = this, b, e;
            this.loadingHelper[a.name] || ("undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (this.loadingHelper[a.name] = c,
            this.loadingHelper.loadOrder.push(a.name),
            b = new Date,
            b = b.getTime(),
            e = a.config.scayt_srcUrl,
            e += 0 <= e.indexOf("?") ? "" : "?" + b,
            this.loadingHelper.ckscaytLoading || (CKEDITOR.scriptLoader.load(e, function(a) {
                if (a) {
            ...
            this.loadingHelper.ckscaytLoading = !0)) : window.SCAYT && "function" === typeof window.SCAYT.CKSCAYT && (CKEDITOR.fireOnce("scaytReady"),
            ...
            a[c] = CKEDITOR.tools.override(a[c], function(a) {
                return function(b) {
                    var c = b.editor.scayt
                      ...
                      , h = null ;
                    CKEDITOR.plugins.scayt && 
                    CKEDITOR.plugins.scayt.state.scayt[b.editor.name] && b.editor.scayt && (this.contents = c.removeMarkupFromString(f) || "",
                ...
                c.on("stylesSet", function(b) {
                    if (b = b.data.styles) {
                        for (var a, h, d, e = 0, n = b.length; e < n; e++)
                            (a = b[e],
                            c.blockless && a.element in CKEDITOR.dtd.$block || (h = a.name,
                            a = new CKEDITOR.style(a),
                            c.filter.customConfig && !c.filter.check(a))) || (a._name = h,
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("tab", {
            init: function(c) {
                ...
                if (b)
                    c.on("key", function(a) {
                        9 == a.data.keyCode && (c.insertText(b),
                        a.cancel())
                    });
                if (d)
                    c.on("key", function(a) {
    ...
    (function() {
        function t(e) {
            function d(a) {
                0 < b.length || a.type != CKEDITOR.NODE_ELEMENT || !C.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(c, a, "selected_cell", !0),
                b.push(a))
            }
            e = e.getRanges();
            for (var b = [], c = {}, a = 0; a < e.length; a++) {
                ...
                if (f.collapsed)
                    ...
                    for (f.guard = d; g = f.next(); )
                        ...
                        !0) || g.getAscendant("th", !0)) && !g.getCustomData("selected_cell") && (CKEDITOR.dom.element.setMarker(c, g, "selected_cell", !0),
                        b.push(g))
                }
            }
        ...
        function p(e, d) {
            ...
            h = 0; a[h] && h < b; h++) {
                var k;
                1 < a[h].rowSpan && g && a[h] == g[h] ? (k = a[h],
                k.rowSpan += 1) : (k = (new CKEDITOR.dom.element(a[h])).clone(),
            ...
            if (e instanceof CKEDITOR.dom.selection) {
                ...
                for (var d = d[d.length - 1], a = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], f = e; f <= a; f++) {
                    ...
                    k = 0; k < g.length; k++) {
                        ...
                        1 == l.$.rowSpan ? l.remove() : (--l.$.rowSpan,
                        n == f && (n = c[f + 1],
                        n[k - 1] ? l.insertAfter(new CKEDITOR.dom.element(n[k - 1])) : (new CKEDITOR.dom.element(b.$.rows[f + 1])).append(l, 1)));
                        k += l.$.colSpan - 1
                    }
                    d.push(h)
                }
        ...
        function m(e, d) {
            for (var b = t(e), c = b[0].getAscendant("table"), a = v(b, 1), b = v(b), a = d ? a : b, f = CKEDITOR.tools.buildTableMap(c), c = [], b = [], g = f.length, h = 0; h < g; h++)
                c.push(f[h][a]),
                b.push(d ? f[h][a - 1] : f[h][a + 1]);
            for (h = 0; h < g; h++)
                c[h] && (1 < c[h].colSpan && b[h] == c[h] ? (a = c[h],
                a.colSpan += 1) : (a = (new CKEDITOR.dom.element(c[h])).clone(),
                a.removeAttribute("colSpan"),
                a.appendBogus(),
                a[d ? "insertBefore" : "insertAfter"].call(a, new CKEDITOR.dom.element(c[h])),
                a = a.$),
                h += a.rowSpan - 1)
        }
        function y(e, d) {
        ...
        function x(e) {
            if (e instanceof CKEDITOR.dom.selection) {
                ...
                a: {
                    ...
                    CKEDITOR.dom.element.clearAllMarkers(a);
                    g = e[0].getParent();
                    (g = g.getPrevious()) ? b = g.getLast() : (g = e[b].getParent(),
                ...
                e instanceof CKEDITOR.dom.element && (d = e.getParent(),
        ...
        d) {
            var b = e.getDocument()
              , c = CKEDITOR.document;
            CKEDITOR.env.ie && 10 == CKEDITOR.env.version && (c.focus(),
            b.focus());
            b = new CKEDITOR.dom.range(b);
            b["moveToElementEdit" + (d ? "End" : "Start")](e) || (b.selectNodeContents(e),
            b.collapse(d ? !1 : !0));
            b.select(!0)
        }
        function z(e, d, b) {
        ...
        function w(e, d, b) {
            ...
            a.type == CKEDITOR.NODE_ELEMENT && a.is("table"))
                return !1;
            var f;
            e = c[0];
            ...
            for (d = 0; d < c.length; d++) {
                ...
                v.trim(),
                f.getChildren().count() && (m == p || !x || x.isBlockBoundary && x.isBlockBoundary({
                    br: 1
                    ...
                    exec: function(a) {
                        ...
                        for (r = e; r <= l; r++)
                            for (m = 0; m < d.length; m++)
                                ...
                                c.$ && (1 == c.$.colSpan ? c.remove() : --c.$.colSpan,
                                m += c.$.rowSpan - 1,
    ...
    (function() {
        ...
        e.prototype = {
            type: function(a, b) {
                ...
                this.typing || (this.hasUndo = this.typing = !0,
                this.hasRedo = !1,
                this.onChange());
                b ? (d = 0,
                this.editor.fire("saveSnapshot")) : this.editor.fire("change");
            ...
            updateSelection: function(a) {
                ...
                var b = this.snapshots
                  , c = b[b.length - 1];
                return c.equalsContent(a) && !c.equalsSelection(a) ? (this.currentImage = b[b.length - 1] = a,
                !0) : !1
            },
            lock: function(a, b) {
                if (this.locked)
        ...
        f.prototype = {
            equalsContent: function(a) {
                var b = this.contents;
                a = a.contents;
                CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.quirks) && (b = b.replace(h, ""),
                a = a.replace(h, ""));
                return b != a ? !1 : !0
            },
            ...
            onKeydown: function(a) {
                ...
                if (229 !== b)
                    if (-1 < CKEDITOR.tools.indexOf(g, a.data.getKeystroke()))
                        a.data.preventDefault();
                    else if (this.keyEventsStack.cleanUp(a),
                    a = this.undoManager,
                    ...
                    this.undoManager.keyGroupChanged(b))
                        if (a.strokesRecorded[0] || a.strokesRecorded[1])
                            a.save(!1, this.lastKeydownImage, !1),
                            a.resetType()
            },
            onInput: function() {
                if (this.ignoreInputEvent)
                    ...
                    this.keyEventsStack.getTotalInputs() >= this.undoManager.strokesLimit && (this.undoManager.type(a.keyCode, !0),

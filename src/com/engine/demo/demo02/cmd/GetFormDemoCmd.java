package com.engine.demo.demo02.cmd;
...
//        }
        ...
        //整数
        SearchConditionItem demo_inputnumber = conditionFactory.createCondition(ConditionType.INPUTNUMBER,502327, "inputNumber");
        demo_inputnumber.setColSpan(2);
        demo_inputnumber.setFieldcol(12);
        demo_inputnumber.setViewAttr(3);  //
        ...
        //密码框设置
        SearchConditionItem demo_password = conditionFactory.createCondition(ConditionType.PASSWORD,502327,"password");
        demo_password.setColSpan(2);
        demo_password.setFieldcol(12);
        demo_password.setViewAttr(3);
        ...
        //密码框设置
//        SearchConditionItem demo_inputsearch = conditionFactory.createCondition(ConditionType.INPUTSEARCH,502327,"inputSearch");
//        demo_inputsearch.setColSpan(2);
//        demo_inputsearch.setFieldcol(12);
//        demo_inputsearch.setViewAttr(3);
...
//        inputItems.add(demo_inputsearch);
        ...
        //多行文本框设置
        SearchConditionItem demo_textarea = conditionFactory.createCondition(ConditionType.TEXTAREA,502327, "textarea");
        ...
        //浏览按钮
        SearchConditionItem demo_browser = conditionFactory.createCondition(ConditionType.BROWSER,502327,"browser","17");
        demo_browser.setValue("demo_browser");
        demo_browser.setColSpan(2);
        demo_browser.setFieldcol(12);
        demo_browser.setLabelcol(6);
        demo_browser.setViewAttr(3);
        ...
        //富文本框
        SearchConditionItem demo_richtext = conditionFactory.createCondition(ConditionType.RICHTEXT,502327, "richText");
         ...
         */
        //日期格式
        SearchConditionItem demo_datepicker = conditionFactory.createCondition(ConditionType.DATEPICKER,502327,"datePicker");
        demo_datepicker.setColSpan(2);
        demo_datepicker.setFieldcol(12);
        demo_datepicker.setLabelcol(6);
        demo_datepicker.setViewAttr(3);
        ...
        //日期组合
        SearchConditionItem demo_dategroup = conditionFactory.createCondition(ConditionType.DATE,502327,"dateGroup");
        demo_dategroup.setColSpan(2);
        demo_dategroup.setFieldcol(12);
        demo_dategroup.setLabelcol(6);
        demo_dategroup.setViewAttr(3);
        ...
        //日期区间
        SearchConditionItem demo_rangepicker = conditionFactory.createCondition(ConditionType.TIMEPICKER,502327,new String[]{"resourcename1","resourcename2"});
        demo_rangepicker.setColSpan(2);
        demo_rangepicker.setFieldcol(12);
        demo_rangepicker.setLabelcol(6);
        demo_rangepicker.setViewAttr(3);
...
//        //时间选择断
//        SearchConditionItem demo_period = conditionFactory.createCondition(ConditionType.PERIOD,502327,new String[]{"startTime","endTime"});
//        demo_period.setColSpan(2);
//        demo_period.setFieldcol(12);
//        demo_period.setLabelcol(6);
//        demo_period.setViewAttr(3);
//        demo_period.setLabel("时间区间");
//        demo_period.setRules("required");
//        demo_period.setValue(new int[]{0,23});
//        dateTimeItems.add(demo_period);

        //联动组件
        //设置主值
        SearchConditionItem demo_selectlinkage = conditionFactory.createCondition(ConditionType.SELECT_LINKAGE,502327, new String[]{"seclevellink1","seclevellink2"});
        ...
        //设置被联动出来的值
        SearchConditionItem demo_selectlinkage_0 = conditionFactory.createCondition(ConditionType.INPUT,502327,"INPUT");
        SearchConditionItem demo_selectlinkage_1 = conditionFactory.createCondition(ConditionType.CHECKBOX,502327,"CHECKBOX");
        SearchConditionItem demo_selectlinkage_2 = conditionFactory.createCondition(ConditionType.RANGEPICKER,502327,new String[]{"start","end"});
...
//        demo_inputsearch.setViewAttr(3);
         ...
         */
        //下拉选择框类
        SearchConditionItem demo_select = conditionFactory.createCondition(ConditionType.SELECT,502327,"SELECT");
        ...
        //check框
        SearchConditionItem demo_checkbox = conditionFactory.createCondition(ConditionType.CHECKBOX,502327,"check");
        demo_checkbox.setColSpan(2);
        demo_checkbox.setFieldcol(12);
        demo_checkbox.setLabelcol(6);
        demo_checkbox.setViewAttr(3);
        ...
        //switch框
        SearchConditionItem demo_switch = conditionFactory.createCondition(ConditionType.SWITCH,502327, "demo_switch");
         ...
         */
        //安全级别
        SearchConditionItem demo_scope =  conditionFactory.createCondition(ConditionType.SCOPE,502327,new String[]{"seclevel","seclevelTo"});
        ...
        //颜色选择器
        SearchConditionItem demo_colorpicker = conditionFactory.createCondition(ConditionType.COLORPICKER,502327, "colorPicker");
        ...
        //附件上传
        SearchConditionItem demo_upload = conditionFactory.createCondition(ConditionType.UPLOAD,502327, "upload");
        ...
        //人力资源
        SearchConditionItem demo_taggroup = conditionFactory.createCondition(ConditionType.TAGGROUP,502327,"tagGroup","17");

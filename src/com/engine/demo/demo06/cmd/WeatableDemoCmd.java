...
//            }
            ...
            table.getColumns().add(new WeaTableColumn("20%", "状态", "state","state","com.engine.demo.demo06.cmd.WeaTableTransMethod.testTransMethod"));
            table.getColumns().add(new WeaTableColumn("20%", "类型", "type","type","com.engine.demo.demo06.cmd.WeaTableTransMethod.getType"));

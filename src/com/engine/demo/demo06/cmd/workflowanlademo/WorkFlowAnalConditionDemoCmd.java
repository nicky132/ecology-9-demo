package com.engine.demo.demo06.cmd.workflowanlademo;
 ...
 * @Description :
 **/
public class WorkFlowAnalConditionDemoCmd extends AbstractCommonCommand<Map<String,Object>> {

    public WorkFlowAnalConditionDemoCmd(User user, Map<String,Object> params) {
        this.user = user;
        this.params = params;
    }
